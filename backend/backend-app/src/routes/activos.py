...
@admin_required
def create_activo(current_user):
...
@admin_required
def update_activo(current_user, activo_id):
...
@admin_required
def assign_activo_to_user(current_user, activo_id, user_id):
...
@admin_required
def get_usuarios_activo(current_user, activo_id):
