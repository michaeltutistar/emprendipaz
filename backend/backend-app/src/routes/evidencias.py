...
@token_required
@admin_required
def get_all_evidencias(current_user):
...
@token_required
@admin_required
def update_evidencia(current_user, evidencia_id):
    ...
    try:
        ...
        if nueva_estado:
            ...
            evidencia.revisado_por = current_user.id
...
@token_required
@admin_required
def download_archivo(current_user, evidencia_id, numero):
...
@token_required
@admin_required
def get_evidencias_estadisticas(current_user):
