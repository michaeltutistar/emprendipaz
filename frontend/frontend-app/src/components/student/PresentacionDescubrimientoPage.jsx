...
import BibliografiaDescubrimientoModal from './BibliografiaDescubrimientoModal';
...
const PresentaciónDescubrimientoPage = () => {
  ...
  } = useModuleProgress('Descubrimiento de Oportunidades');
  ...
  const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Descubrimiento de Oportunidades');
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#006837] via-[#00844a] to-[#59D22E]">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Descubrimiento de Oportunidades</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo2/M2INTRO.mp4"

                    poster="/Modulo2/screeninicio.jpg"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  descripcion="Aprende sobre diagnóstico estratégico y análisis del macroentorno mediante la herramienta PESTEL para identificar oportunidades y amenazas."
                  estaCompletada={unidad1Completada}
                  estaDisponible={unidadesDisponibles[1] ?? true}
                  unidadAnteriorCompletada={true}
                  ruta="/student/descubrimiento-oportunidades/unidad1/inicio"
                  delay={0.1}
                ...
                <UnidadCard
                  ...
                  unidadNumero={2}
                  titulo="Validación de Oportunidades"
                  descripcion="Valida las oportunidades identificadas mediante herramientas de investigación y análisis de mercado."
                  estaCompletada={unidad2Completada}
                  estaDisponible={unidadesDisponibles[2] ?? false}
                  unidadAnteriorCompletada={unidad1Completada}
                  ruta="/student/descubrimiento-oportunidades/unidad2/inicio"
                  delay={0.2}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Continuar"
                />
                ...
                <UnidadCard
                  ...
                  descripcion="Aprende sobre las 4 etapas del ciclo de vida del producto y cómo aplicarlo a tu emprendimiento mediante el taller 'Desarrollando mi Producto'."
                  estaCompletada={unidad3Completada}
                  estaDisponible={unidadesDisponibles[3] ?? false}
                  unidadAnteriorCompletada={unidad2Completada}
                  ruta="/student/descubrimiento-oportunidades/unidad3/inicio"
                  delay={0.3}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Continuar"
                />
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/descubrimiento-oportunidades/plan-negocio')}
      ...
      {showBibliografia && <BibliografiaDescubrimientoModal onClose={() => setShowBibliografia(false)} />}
...
export default PresentaciónDescubrimientoPage;
