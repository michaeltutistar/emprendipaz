...
const Unidad1InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Marketing y Comercialización', 'Unidad 1: Inicio');
...
const handleCompleteStep = async () => {
    ...
    navigate('/student/unidad1/desarrollo');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="sticky top-0 z-50">
        ...
        >
          ...
          {/* CAPA FONDO 1: Degradado animado SIN blur - colores puros */}
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Fundamentos del Marketing</span>
...
{/* Paso 1 */}
            ...
            <div className="flex flex-col items-center relative z-10 bg-white px-1">
              ...
              <p className="text-[10px] text-emerald-700 font-bold">Presentación</p>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Esta unidad presenta los <strong>fundamentos sobre la caracterización interna y externa del negocio</strong>.

              Identificarás cómo la matriz DOFA permite reconocer fortalezas, debilidades, oportunidades y amenazas para
...
export default Unidad1InicioPage;
