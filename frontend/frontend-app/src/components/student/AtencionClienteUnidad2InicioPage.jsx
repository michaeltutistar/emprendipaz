...
const AtencionClienteUnidad2InicioPage = () => {
                  ...
                  if (videoRef.current) {
                    ...
                    if (progress >= 99.5 || video.currentTime >= video.duration - 0.5) {
                      ...
                      if (!videoMarkedAsSeen) {
                        ...
                        sessionStorage.setItem('ac_unidad2_video_visto', 'true');
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás a gestionar de manera efectiva las quejas y reclamaciones de tus clientes.

              Comprenderás la diferencia entre una queja y un reclamo, y dominarás un protocolo de 4 pasos que te permitirá

              manejar estas situaciones con profesionalismo.
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              clientes, garantizando una atención eficiente, respetuosa y oportuna.
...
export default AtencionClienteUnidad2InicioPage;
