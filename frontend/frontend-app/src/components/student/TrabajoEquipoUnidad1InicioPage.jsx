...
const TrabajoEquipoUnidad1InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/trabajo-equipo/unidad1/desarrollo');
...
{/* Título modulo centrado al hacer scroll */}
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Conformación del Equipo</span>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden shadow-xl">
                ...
                <video
                  ...
                  onPlay={() => setVideoMarkedAsSeen(false)}
...
{/* Texto - Columna derecha (30%) */}
            ...
            <div className="lg:col-span-3 flex flex-col justify-center gap-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Un equipo de trabajo es el conjunto de personas con roles claramente definidos que colaboran para alcanzar los objetivos 

                del negocio. Conocer cómo está conformado tu equipo de trabajo te permite distribuir tareas con claridad, evitar 

                confusiones y mejorar los resultados.
...
export default TrabajoEquipoUnidad1InicioPage;
