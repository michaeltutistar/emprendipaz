...
const ProyectoVidaUnidad1InicioPage = () => {

  const navigate = useNavigate();

  const [videoInView, setVideoInView] = useState(false);

  const { pasoCompletado, registrarProgreso } = useProgressTracking('Proyecto de vida', 'Unidad 1: Presentación');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Valores e intereses personales</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              A través de este recorrido, aprenderás a identificar tus valores personales, reconocer tus intereses

              y cómo estos se relacionan con tu emprendimiento para tomar decisiones coherentes.
...
export default ProyectoVidaUnidad1InicioPage;
