...
const preguntas = [

  {
    ...
    pregunta: 'Dentro de la caracterización de un emprendimiento, el segmento de mercado permite:',

    opciones: [

      { id: 'A', texto: 'Conocer los gustos, necesidades y comportamiento del cliente potencial.' },

      { id: 'B', texto: 'Determinar la ubicación geográfica del proveedor.' },

      { id: 'C', texto: 'Calcular la rentabilidad del proyecto.' }
...

  {
    ...
    pregunta: 'La matriz DOFA se utiliza principalmente para:',

    opciones: [

      { id: 'A', texto: 'Evaluar la situación financiera de la empresa.' },

      { id: 'B', texto: 'Analizar las fortalezas, oportunidades, debilidades y amenazas.' },

      { id: 'C', texto: 'Calcular los costos de producción.' }
...

  {
    ...
    pregunta: 'En un análisis DOFA, identificar que una empresa cuenta con personal altamente capacitado corresponde a:',

    opciones: [

      { id: 'A', texto: 'Una amenaza' },

      { id: 'B', texto: 'Una debilidad' },

      { id: 'C', texto: 'Una fortaleza' },

      { id: 'D', texto: 'Una oportunidad' }
...

  {
    ...
    pregunta: 'La entrada de nuevos competidores al mercado se clasifica como:',

    opciones: [

      { id: 'A', texto: 'Una oportunidad' },

      { id: 'B', texto: 'Una amenaza' },

      { id: 'C', texto: 'Una fortaleza' },

      { id: 'D', texto: 'Una debilidad' }
...

  {
    ...
    pregunta: '¿Qué herramienta resulta útil para caracterizar el emprendimiento y su entorno?',

    opciones: [

      { id: 'A', texto: 'La matriz FODA (Fortalezas, Oportunidades, Debilidades y Amenazas).' },

      { id: 'B', texto: 'El flujo de caja proyectado.' },

      { id: 'C', texto: 'El informe de ingresos, costos y gastos.' }
...
const Unidad1CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Marketing y Comercialización', 'Unidad 1: Evaluación');
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              Cierre · Evaluación Unidad 1

            </h1>

            <p className="text-white/80 max-w-2xl text-sm md:text-base">

              Valida tus conocimientos sobre caracterización interna y externa del negocio y el

              uso de la matriz DOFA en marketing y comercialización.
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-8">
          ...
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex flex-col items-center relative z-10 bg-white px-1">
              ...
              <p className="text-[10px] text-emerald-700 font-bold">Evaluación</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
          ...
          {evaluaciónBloqueada && (
            ...
            <div className="bg-green-50 border-l-4 border-green-500 text-green-800 p-4 mb-6 rounded-lg" role="alert">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-2xl md:text-[32px] font-bold text-neutral-900 mb-4">1.2 Cierre</h2>

            <h3 className="text-xl md:text-2xl font-bold text-neutral-800 mb-2">EVALUACIÓN UNIDAD UNO</h3>

            <p className="text-neutral-700 font-semibold mb-4">Caracterización interna y externa del negocio</p>

            <p className="text-neutral-600 text-sm md:text-base">

              Responde las cinco preguntas de selección múltiple sobre la caracterización interna y externa del negocio.
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-between">
            ...
            <Button
              ...
              onClick={() => navigate('/student/unidad1/taller')}
...
export default Unidad1CierrePage;
