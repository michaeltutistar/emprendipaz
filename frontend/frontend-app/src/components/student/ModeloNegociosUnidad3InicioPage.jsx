...
const ModeloNegociosUnidad3InicioPage = () => {
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              Recursos, Ingresos, Costos y Validación del Modelo
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás sobre los recursos clave necesarios para operar tu modelo de negocio, cómo analizar costos fijos y variables, calcular el punto de equilibrio y validar tu modelo mediante metodologías como Lean Startup.

            </p>

            <p className="text-gray-700 leading-relaxed">

              A través de conceptos teóricos, herramientas prácticas y casos de estudio, desarrollarás habilidades para evaluar la viabilidad financiera de tu modelo y validarlo con evidencia real del mercado.
...
export default ModeloNegociosUnidad3InicioPage;
