...
const MarketingDigitalUnidad2Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/marketing-digital/unidad2/inicio',

      descripcion: 'Video y contexto de la unidad sobre metas de marketing digital'
...

    {
      ...
      ruta: '/student/marketing-digital/unidad2/desarrollo',

      descripcion: 'Metodología SMART, tipos de objetivos y casos de estudio'
...

    {
      ...
      ruta: '/student/marketing-digital/unidad2/taller',

      descripcion: 'Convierte objetivos generales en objetivos SMART aplicando la metodología'
...

    {
      ...
      ruta: '/student/marketing-digital/unidad2/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre metas de marketing digital'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 2: Metas de Marketing Digital</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En la primera unidad elaboramos el diagnóstico de presencia digital, mediante el cual, podemos detectar aspectos a mejorar, algunos pueden identificarse de manera inmediata (ejemplo, actualizar datos de contacto). Sin embargo, otros hallazgos implican una reflexión más profunda, es en este escenario en donde surgen las metas de marketing digital.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Las metas de marketing digital pueden definirse como una declaración clara y específica de los objetivos a los cuales nuestro emprendimiento aspira mediante el desarrollo de estrategias.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/marketing-digital/unidad2/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás la metodología SMART para definir metas de marketing digital, los tipos de objetivos (corto y largo plazo), objetivos comunes en marketing digital y casos de estudio prácticos.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/marketing-digital/unidad2/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica la metodología SMART para convertir objetivos generales en objetivos SMART. Completa los tres objetivos propuestos adaptándolos a tu emprendimiento.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/marketing-digital/unidad2/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre metas de marketing digital antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/marketing-digital/unidad2/cierre')}
...
export default MarketingDigitalUnidad2Page;
