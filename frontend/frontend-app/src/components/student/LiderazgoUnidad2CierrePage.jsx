...
const preguntas = [

  {
    ...
    pregunta: '¿Cuál es una capacidad esencial de un líder?',

    opciones: [

      { id: 'A', texto: 'Imponer reglas sin consultar al equipo de trabajo.' },

      { id: 'B', texto: 'Motivar y levantar la moral en momentos difíciles.' },

      { id: 'C', texto: 'Delegar todo.' }
...

  {
    ...
    pregunta: '¿Cuál es una característica del liderazgo visionario?',

    opciones: [

      { id: 'A', texto: 'Se enfoca exclusivamente en resultados inmediatos.' },

      { id: 'B', texto: 'Inspira a través de una visión clara y compartida.' },

      { id: 'C', texto: 'Se basa en la autoridad y el control implacable.' }
...

  {
    ...
    pregunta: '¿Qué función cumple la comunicación clara en el liderazgo visionario?',

    opciones: [

      { id: 'A', texto: 'Evita que el equipo cuestione las decisiones.' },

      { id: 'B', texto: 'Transmite entusiasmo sin explicar razones.' },

      { id: 'C', texto: 'Explica el "por qué" detrás de cada acción.' }
...

  {
    ...
    pregunta: '¿Cuál es un riesgo de no aplicar la empatía estratégica como líder?',

    opciones: [

      { id: 'A', texto: 'El equipo de trabajo se vuelve demasiado competente.' },

      { id: 'B', texto: 'Se pierde conexión entre las necesidades del equipo y los objetivos.' },

      { id: 'C', texto: 'Se genera exceso de sabiduría en el líder.' }
...

  {
    ...
    pregunta: '¿En qué contexto es más útil aplicar el liderazgo visionario?',

    opciones: [

      { id: 'A', texto: 'Cuando se necesita transformar profundamente la cultura organizacional.' },

      { id: 'B', texto: 'En tareas operativas rutinarias sin impacto comercial.' },

      { id: 'C', texto: 'Para resolver conflictos entre colaboradores.' }
...
const LiderazgoUnidad2CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Liderazgo', 'Unidad 2: Evaluación');
...
{/* Instrucciones al lado del título */}
          ...
          <div className="bg-gradient-to-r from-[#AA27B9]/10 to-[#d946ef]/10 border-l-3 border-[#AA27B9] rounded-xl p-2.5 flex-1 max-w-md">
            ...
            <p className="text-gray-700 leading-snug text-xs">
              ...
              <strong>📌 Instrucciones:</strong> Para cerrar la Unidad 2 "Liderazgo Visionario", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default LiderazgoUnidad2CierrePage;
