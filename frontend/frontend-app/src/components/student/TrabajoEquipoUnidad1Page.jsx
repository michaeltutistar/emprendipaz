...
const TrabajoEquipoUnidad1Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/trabajo-equipo/unidad1/inicio',

      descripcion: 'Video y contexto de la unidad sobre conformación del equipo de trabajo'
...

    {
      ...
      ruta: '/student/trabajo-equipo/unidad1/desarrollo',

      descripcion: 'Fundamentos sobre equipos de trabajo, funciones clave y organigrama circular'
...

    {
      ...
      ruta: '/student/trabajo-equipo/unidad1/taller',

      descripcion: 'Identifica las funciones de cada persona emparejando acciones con funciones'
...

    {
      ...
      ruta: '/student/trabajo-equipo/unidad1/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre conformación del equipo de trabajo'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 1: Conformación del Equipo de Trabajo</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás a identificar las funciones clave de tu equipo de trabajo y a visualizar su estructura

                mediante organigramás circulares que representan el trabajo colaborativo.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Conocer cómo está conformado tu equipo te permite distribuir tareas con claridad, evitar confusiones y mejorar los resultados.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/trabajo-equipo/unidad1/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los fundamentos sobre equipos de trabajo, las 5 funciones clave y cómo utilizar

                el organigrama circular para visualizar la estructura de tu emprendimiento.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/trabajo-equipo/unidad1/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica tus conocimientos identificando las funciones de cada persona de acuerdo a la actividad que realiza en la empresa.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/trabajo-equipo/unidad1/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre conformación del equipo de trabajo antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/trabajo-equipo/unidad1/cierre')}
...
export default TrabajoEquipoUnidad1Page;
