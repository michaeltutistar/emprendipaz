...
const preguntas = [

  {
    ...
    pregunta: 'La ecuación patrimonial expresa la relación fundamental entre:',

    opciones: [

      { id: 'A', texto: 'Ventas, costos y gastos' },

      { id: 'B', texto: 'Activos, pasivos y patrimonio' },

      { id: 'C', texto: 'Ingresos, egresos y utilidades' }
...

  {
    ...
    pregunta: '¿Qué representan los activos de una empresa?',

    opciones: [

      { id: 'A', texto: 'Los bienes y derechos que posee' },

      { id: 'B', texto: 'Las deudas con terceros' },

      { id: 'C', texto: 'El capital aportado por los propietarios' }
...

  {
    ...
    pregunta: '¿Cuál es la función principal de la contabilidad dentro de la gestión empresarial?',

    opciones: [

      { id: 'A', texto: 'Proyectar escenarios futuros' },

      { id: 'B', texto: 'Registrar, organizar y presentar operaciones económicas' },

      { id: 'C', texto: 'Administrar la capacidad financiera futura' }
...

  {
    ...
    pregunta: 'En el caso de la tienda "Dulces y Sabor", el aporte inicial de $6.000.000 se clasifica como:',
...

  {
    ...
    pregunta: '¿Qué revela el Balance General o Estado de situación financiera?',

    opciones: [

      { id: 'A', texto: 'La posición financiera actual de la empresa' },

      { id: 'B', texto: 'Las proyecciones de ventas futuras' },

      { id: 'C', texto: 'El plan de marketing de la organización' }
        ...
        <div className="p-8 space-y-4">
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Felicitaciones! Has completado la Unidad 1 de Finanzas y Gestión Empresarial.
...
const FinanzasUnidad1CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Finanzas y Gestión Empresarial', 'Unidad 1: Evaluación');
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">Unidad 1 · Evaluación</span>
          ...
          <div className="mb-6">
            ...
            <div className="bg-neutral-100 border-l-4 border-green-400/80 p-4 rounded">
              ...
              <p className="text-neutral-700 text-sm md:text-base">
                ...
                Para cerrar la Unidad 1: "Estudio de la ecuación patrimonial", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default FinanzasUnidad1CierrePage;
