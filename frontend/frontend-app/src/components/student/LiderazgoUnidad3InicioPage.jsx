...
const LiderazgoUnidad3InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/liderazgo/unidad3/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Toma de Decisiones</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Para un líder, saber tomar decisiones no es solo elegir entre un conjunto de opciones, sino construir confianza, movilizar al equipo de trabajo y transformar la visión en acción. Un líder que decide adecuadamente no solo resuelve problemas, además crea futuro.

            </p>

            <p className="text-gray-700 leading-relaxed">

              En esta unidad aprenderás los fundamentos sobre la toma de decisiones, las premisas que debe considerar un líder, y una ruta práctica para tomar decisiones efectivas en tu emprendimiento.
...
export default LiderazgoUnidad3InicioPage;
