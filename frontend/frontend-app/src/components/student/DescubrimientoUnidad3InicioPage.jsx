...
const DescubrimientoUnidad3InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Descubrimiento de Oportunidades', 'Unidad 3: Presentación');
...
const handleCompleteStep = async () => {
    ...
    navigate('/student/descubrimiento-oportunidades/unidad3/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Ciclo de Vida del Producto</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              El ciclo de vida de un producto (CVP) es una herramienta clave del marketing que permite comprender las etapas por las que pasa un producto desde su creación hasta su salida del mercado.

            </p>

            <p className="text-gray-700 leading-relaxed">

              En está unidad aprenderás sobre las 4 etapas del ciclo de vida del producto (Introducción, Crecimiento, Madurez y Declive) y cómo aplicar está modelo a tu emprendimiento mediante el taller "Desarrollando mi Producto".
...
export default DescubrimientoUnidad3InicioPage;
