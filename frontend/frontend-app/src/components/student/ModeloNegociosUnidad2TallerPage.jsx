...
const componentesPropuesta = [

  { id: 'diferenciacion', nombre: 'Diferenciación' },

  { id: 'necesidad-resuelve', nombre: 'Necesidad que resuelve' },

  { id: 'generador-confianza', nombre: 'Generador de confianza' },

  { id: 'valor-emocional', nombre: 'Valor emocional' },

  { id: 'atractivo-mercado', nombre: 'Atractivo en el mercado' },

  { id: 'compromiso-adicional', nombre: 'Compromiso adicional' }

];

// Descripciones para arrastrar (ordenado diferente a componentesPropuesta para evitar ventaja)
...
const descripciones = [

  {
    ...
    texto: 'Sostenibilidad y cuidado del medio ambiente',

    respuestaCorrecta: 'compromiso-adicional'
...

  {
    ...
    texto: 'Garantía o respaldo ofrecido',

    respuestaCorrecta: 'generador-confianza'
...

  {
    ...
    texto: 'Relación costo-beneficio',

    respuestaCorrecta: 'atractivo-mercado'
...

  {
    ...
    texto: 'Innovación y originalidad frente a la competencia',

    respuestaCorrecta: 'diferenciacion'
...

  {
    ...
    texto: 'Orgullo de consumir algo único/local',

    respuestaCorrecta: 'valor-emocional'
...

  {
    ...
    texto: 'Ahorra tiempo o esfuerzo al cliente',

    respuestaCorrecta: 'necesidad-resuelve'

  }

];

const ModeloNegociosUnidad2TallerPage = () => {
  ...
  const [respuestas, setRespuestas] = useState(() => {
    ...
    const saved = localStorage.getItem('modelo_negocios_u2_taller_respuestas');
  ...
  const [descripcionesDisponibles, setDescripcionesDisponibles] = useState(() => {
    ...
    const saved = localStorage.getItem('modelo_negocios_u2_taller_disponibles');
  ...
  const [validado, setValidado] = useState(() => {
    ...
    const saved = localStorage.getItem('modelo_negocios_u2_taller_validado');
...
useEffect(() => {
    ...
    localStorage.setItem('modelo_negocios_u2_taller_respuestas', JSON.stringify(respuestas));

  }, [respuestas]);

useEffect(() => {

    localStorage.setItem('modelo_negocios_u2_taller_disponibles', JSON.stringify(descripcionesDisponibles));

  }, [descripcionesDisponibles]);

useEffect(() => {

    localStorage.setItem('modelo_negocios_u2_taller_validado', validado.toString());
...
const handleReset = () => {
    ...
    localStorage.removeItem('modelo_negocios_u2_taller_respuestas');

    localStorage.removeItem('modelo_negocios_u2_taller_disponibles');

    localStorage.removeItem('modelo_negocios_u2_taller_validado');

  };

const todasRespondidas = Object.keys(respuestas).length === componentesPropuesta.length;

  const respuestasCorrectasCount = componentesPropuesta.filter(c => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/modelo-negocios/unidad2/cierre');
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            >
              ...
              Taller: construyendo la propuesta de valor

            </h2>

            <p className="text-neutral-700 mb-4 text-sm md:text-base leading-relaxed">

              Realizaremos el siguiente taller para reforzar conocimientos sobre propuesta de valor. Vas a reconocer a qué componente de la propuesta de valor corresponde una descripción específica.
            ...
            <div className="bg-gradient-to-r from-[#AA27B9]/10 to-[#d946ef]/10 border-l-3 border-[#AA27B9] rounded-xl p-2.5 mb-6">
              ...
              <p className="text-gray-700 leading-snug text-xs">
                ...
                <strong>📌 Instrucción del taller:</strong> Arrastra cada descripción de la derecha hacia el componente correcto de la propuesta de valor en la izquierda.
...
<div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Columna Izquierda: Componentes de la propuesta de valor */}

                <div>

                  <h4 className="font-semibold text-neutral-900 mb-4 text-center">Componente de la propuesta de valor (arrastrar aquí)</h4>

                  <div className="space-y-3">

                    {componentesPropuesta.map((componente) => {
                ...
                <div className="flex gap-4 items-center">
                  ...
                  {validado && (
                    ...
                    <div className="text-sm text-neutral-700">
                      ...
                      <span className="font-semibold">Resultado:</span> {respuestasCorrectasCount} de {componentesPropuesta.length} correctas
                  ...
                  {validado && respuestasCorrectasCount === componentesPropuesta.length && (
...
{/* Texto Final */}
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border-l-4 border-green-600 p-6 rounded-lg">
            ...
            <p className="text-neutral-700 text-center text-base md:text-lg italic">
              ...
              Tu propuesta de valor es la voz de tu negocio: haz que sea clara, única y memorable.
      ...
      <div className="fixed bottom-8 left-8 z-40">
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigate('/student/modelo-negocios/unidad2/desarrollo');
...
export default ModeloNegociosUnidad2TallerPage;
