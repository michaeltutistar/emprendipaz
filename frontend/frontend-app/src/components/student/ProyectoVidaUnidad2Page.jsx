...
const ProyectoVidaUnidad2Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/proyecto-vida/unidad2/inicio',

      descripcion: 'Video y contexto de la unidad sobre fortalezas propias'
...

    {
      ...
      ruta: '/student/proyecto-vida/unidad2/desarrollo',

      descripcion: 'Fundamentos sobre fortalezas propias, aplicaciones en el emprendimiento y casos de estudio'
...

    {
      ...
      ruta: '/student/proyecto-vida/unidad2/taller',

      descripcion: 'Empareja tus fortalezas con actividades del emprendimiento'
...

    {
      ...
      ruta: '/student/proyecto-vida/unidad2/cierre',
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 2: Fortalezas propias</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Empezaremos reconociendo tus capacidades y fortalezas personales. Este paso te permitirá definir qué tipo de actividades puedes realizar con éxito y en qué áreas requieres apoyo o formación adicional.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Verás el video introductorio y revisarás los fundamentos sobre fortalezas propias antes de continuar con el taller.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/proyecto-vida/unidad2/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los fundamentos sobre fortalezas propias, cómo se aplican en el emprendimiento, y casos de estudio prácticos.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/proyecto-vida/unidad2/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Llevarás la teoría a la práctica emparejando tus fortalezas con actividades del emprendimiento. Arrastra cada actividad hacia la fortaleza correspondiente.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/proyecto-vida/unidad2/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre fortalezas propias antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/proyecto-vida/unidad2/cierre')}
...
export default ProyectoVidaUnidad2Page;
