...
const PresentaciónAtencionClientePage = () => {
...
// Usar hook personalizado para cargar progreso desde backend
  ...
  } = useModuleProgress('Atención al Cliente');
...
const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Atención al Cliente');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Atención al Cliente</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo6/M6INTRO.mp4"

                    poster="/Modulo6/screeninicio.jpg"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  descripcion="Aprende sobre la importancia de la atención al cliente y comprende el ciclo completo del servicio con sus 11 pasos y los momentos de verdad."
                  ...
                  ruta="/student/atencion-cliente/unidad1"
...
{/* Unidad 2 */}
                ...
                <UnidadCard
                  ...
                  titulo="Gestión de Quejas y Reclamás"

                  descripcion="Aprende a diferenciar entre quejas y reclamás, y domina el protocolo de 4 pasos: Recibir, Verificar, Responder y Cerrar."
                  ...
                  ruta="/student/atencion-cliente/unidad2"
...
{/* Unidad 3 */}
                ...
                <UnidadCard
                  ...
                  titulo="Resolución de Conflictos y Manejo de Clientes Difíciles"

                  descripcion="Conoce los canales oficiales de atención y aprende estrategias específicas para manejar diferentes tipos de clientes difíciles."
                  ...
                  ruta="/student/atencion-cliente/unidad3"
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/atencion-cliente/plan-negocio')}
...
export default PresentaciónAtencionClientePage;
