...
const PlanInversionUnidad1InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/plan-inversion/unidad1/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Fundamentación Teórica del Plan de Inversión</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Antes de invertir un peso en tu emprendimiento, necesitas claridad conceptual. ¿Qué es realmente un plan de inversión? 

              ¿En qué se diferencia de otras herramientas que quizás ya conoces? ¿Cuáles son sus componentes fundamentales? 

              ¿Por qué es crítico en contextos de formalización empresarial?

            </p>

            <p className="text-gray-700 leading-relaxed">

              Esta Unidad responde estas preguntas de forma clara y accesible. No es teoría aislada: cada concepto está conectado 

              directamente a la realidad de tu emprendimiento.
...
export default PlanInversionUnidad1InicioPage;
