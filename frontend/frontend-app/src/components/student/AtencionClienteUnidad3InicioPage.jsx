...
const AtencionClienteUnidad3InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Atención al Cliente y Resolución de Conflictos', 'Unidad 3: Presentación');
...
// Verificar si el video ya fue visto en está sesión
    ...
    const videoVisto = sessionStorage.getItem('ac_unidad3_video_visto');
                  ...
                  if (videoRef.current) {
                    ...
                    if (progress >= 99.5 || video.currentTime >= video.duration - 0.5) {
                      ...
                      if (!videoMarkedAsSeen) {
                        ...
                        sessionStorage.setItem('ac_unidad3_video_visto', 'true');
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás sobre los canales oficiales de atención a quejas y reclamaciones, y conocerás estrategias específicas

              para manejar diferentes tipos de clientes difíciles que puedes encontrar en el día a día de tu emprendimiento.

            </p>

            <p className="text-gray-700 leading-relaxed">

              Estos perfiles, conocidos como clientes difíciles, no deben interpretarse como amenazas, sino como oportunidades para

              demostrar profesionalismo, fortalecer la reputación del negocio y generar aprendizajes valiosos para la mejora continua.
...
export default AtencionClienteUnidad3InicioPage;
