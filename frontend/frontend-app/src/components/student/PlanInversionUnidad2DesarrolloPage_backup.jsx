...
{/* Diferencia con el plan de negocios */}
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-base md:text-lg text-gray-700 ml-4">
                  ...
                  <li><strong>Plan de negocios:</strong> describe la estrategia comercial, el mercado y la propuestá de valor.</li>
...
{/* Decisión final */}
            ...
            <div className="bg-gradient-to-br from-[#59D22E]/10 to-[#A5E811]/10 border-l-4 border-[#59D22E] p-6 rounded-xl">
              ...
              <p className="text-base md:text-lg leading-relaxed text-gray-700 mb-4">
                ...
                <strong>Razón:</strong> combina durabilidad del activo con flexibilidad laboral, requiere menor endeudamiento y permite aumentar capacidad sin comprometer demásiado flujo de caja.

              </p>

              <p className="text-base md:text-lg leading-relaxed text-gray-700">

                <strong>Aprendizaje:</strong> el plan de inversión permitió comparar alternativas con datos claros, evitando decisiones impulsivas y mástrando cuál opción es más sostenible en el contexto actual.
