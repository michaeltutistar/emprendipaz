...
import { ArrowLeft, Play, ChevronRight, Home, ArrowDown, ChevronDown, LogOut } from 'lucide-react';
...
const DescubrimientoUnidad2InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Descubrimiento de Oportunidades', 'Unidad 2: Presentación');

  const [, setVideoMarkedAsSeen] = useState(pasoCompletado);
...
// Sincronizar videoMarkedAsSeen con pasoCompletado

  useEffect(() => {

    setVideoMarkedAsSeen(pasoCompletado);

  }, [pasoCompletado]);

const handleCompleteStep = async () => {

    // Marcar este paso como completado aunque el usuario no vea el video
    await registrarProgreso();

    navigate('/student/descubrimiento-oportunidades/unidad2/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Diamante de Porter</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              El diamante de Porter es una herramienta estratégica desarrollada por Michael Porter que permite analizar la competitividad de un país o región en una industria específica. Esta herramienta ayuda a entender cómo las condiciones del entorno nacional pueden influir en la capacidad de las empresas para competir internacionalmente.

            </p>

            <p className="text-gray-700 leading-relaxed">

              En está unidad aprenderás sobre los cuatro factores del diamante de Porter y cómo aplicarlos para analizar la competitividad de tu emprendimiento en el contexto empresarial.
...
export default DescubrimientoUnidad2InicioPage;
