...
const AtencionClienteUnidad2Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/atencion-cliente/unidad2/inicio',

      descripcion: 'Video y contexto de la unidad sobre gestión de quejas y reclamaciones'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad2/desarrollo',

      descripcion: 'Fundamentos sobre quejas vs reclamaciones y protocolo de 4 pasos: Recibir, Verificar, Responder y Cerrar'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad2/taller',

      descripcion: 'Aplica el protocolo de atención de quejas y reclamaciones en situaciones prácticas'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad2/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre gestión de quejas y reclamaciones'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 2: Gestión de Quejas y Reclamaciones</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás a diferenciar entre quejas y reclamaciones, y dominarás el protocolo de 4 pasos para gestionarlos de manera efectiva: Recibir, Verificar, Responder y Cerrar.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Este protocolo te permitirá manejar situaciones difíciles con profesionalismo y convertir problemas en oportunidades de fidelización.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/atencion-cliente/unidad2/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los fundamentos sobre quejas y reclamaciones, aprenderás a diferenciarlos y dominarás el protocolo de 4 pasos para gestionarlos efectivamente.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad2/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica el protocolo de atención de quejas y reclamaciones en situaciones prácticas. Practica los 4 pasos: Recibir, Verificar, Responder y Cerrar.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad2/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre gestión de quejas y reclamaciones antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad2/cierre')}
...
export default AtencionClienteUnidad2Page;
