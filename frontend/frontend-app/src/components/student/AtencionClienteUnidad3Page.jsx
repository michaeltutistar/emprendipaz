...
const AtencionClienteUnidad3Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/atencion-cliente/unidad3/inicio',

      descripcion: 'Video y contexto de la unidad sobre resolución de conflictos y manejo de clientes difíciles'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad3/desarrollo',

      descripcion: 'Canales oficiales de atención y estrategias para manejar diferentes tipos de clientes difíciles'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad3/taller',

      descripcion: 'Aplica estrategias de manejo de clientes difíciles en situaciones prácticas'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad3/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre resolución de conflictos y manejo de clientes difíciles'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <p className="text-xs tracking-wide mb-1 opacity-80">MÓDULO: Atención al Cliente y Resolución de Conflictos</p>

          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 3: Resolución de Conflictos y Manejo de Clientes Difíciles</h1>
      ...
      <div className="bg-neutral-200 py-3 px-4 sm:px-8 border-b border-neutral-300 sticky top-[152px] z-40">
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-neutral-600">
          ...
          <button onClick={() => navigate('/student/atencion-cliente')} className="hover:text-neutral-900 transition-colors">
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás sobre los canales oficiales de atención y estrategias específicas para manejar diferentes tipos de clientes difíciles.

                También conocerás técnicas de resolución de conflictos que te permitirán convertir situaciones desafiantes en oportunidades de mejora.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Dominar estas habilidades es fundamental para mantener relaciones positivas con todos tus clientes, incluso en situaciones complejas.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/atencion-cliente/unidad3/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los canales oficiales de atención, aprenderás estrategias específicas para manejar diferentes tipos de clientes difíciles y técnicas de resolución de conflictos.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad3/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica las estrategias de manejo de clientes difíciles en situaciones prácticas. Practica las técnicas aprendidas para resolver conflictos de manera efectiva.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad3/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre resolución de conflictos y manejo de clientes difíciles antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad3/cierre')}
...
export default AtencionClienteUnidad3Page;
