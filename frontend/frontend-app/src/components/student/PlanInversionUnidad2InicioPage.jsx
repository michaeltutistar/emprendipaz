...
const PlanInversionUnidad2InicioPage = () => {

  const navigate = useNavigate();

  const [, setVideoInView] = useState(false);
    ...
    try {
      ...
      await fetch(`${API_BASE_URL}/registrar-progreso-modulo`, {
        ...
        body: JSON.stringify({
          ...
          paso_nombre: 'Unidad 2: Presentación',
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <button onClick={() => navigate('/student/plan-inversion')} className="hover:text-white transition-colors">
              ...
              <span className="text-white font-semibold">Análisis y Estructura Financiera del Plan de Inversión</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás a analizar las necesidades de inversión de tu emprendimiento, identificar fuentes de financiamiento 

              adecuadas y proyectar flujos de caja para evaluar la viabilidad financiera de tus inversiones.

            </p>

            <p className="text-gray-700 leading-relaxed">

              El análisis financiero es el puente entre la teoría de la inversión (Unidad 1) y la ejecución práctica (Unidad 3). 

              Comprender cómo se estructura el dinero, cómo se proyectan resultados, y cómo se miden indicadores, es lo que diferencia 

              a un emprendedor que crece de forma sostenible de uno que crece por azar.
...
export default PlanInversionUnidad2InicioPage;
