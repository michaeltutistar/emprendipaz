...
const ModeloNegociosUnidad1InicioPage = () => {
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Business Model Canvas</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              El Business Model Canvas es una herramienta visual que estructura el modelo de negocios en nueve bloques interconectados, 

              permitiendo análisis, comunicación y validación del modelo en una única página.

            </p>

            <p className="text-gray-700 leading-relaxed">

              En esta unidad aprenderás sobre los 9 elementos del Business Model Canvas y cómo aplicarlos a tu emprendimiento mediante 
...
export default ModeloNegociosUnidad1InicioPage;
