...
const ModeloNegociosUnidad2Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/modelo-negocios/unidad2/inicio',

      descripcion: 'Video y contexto de la unidad sobre Análisis de Segmentos, Canales y Propuesta de Valor'
...

    {
      ...
      ruta: '/student/modelo-negocios/unidad2/desarrollo',

      descripcion: 'Fundamentos sobre segmentación, buyer personas, canales y propuesta de valor'
...

    {
      ...
      ruta: '/student/modelo-negocios/unidad2/taller',

      descripcion: 'Aplica los conceptos de segmentación y propuesta de valor a tu emprendimiento'
...

    {
      ...
      ruta: '/student/modelo-negocios/unidad2/cierre',
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 2: Análisis de Segmentos, Canales y Propuesta de Valor</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Empezaremos aprendiendo sobre segmentación de mercado, buyer personas, gestión de canales y propuesta de valor.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/modelo-negocios/unidad2/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los fundamentos sobre segmentación, buyer personas, matriz de canales y validación de propuesta de valor.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/modelo-negocios/unidad2/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Llevarás la teoría a la práctica aplicando los conceptos de segmentación y propuesta de valor a tu emprendimiento.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/modelo-negocios/unidad2/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde el cuestionario de cierre sobre segmentación, canales y propuesta de valor antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/modelo-negocios/unidad2/cierre')}
...
export default ModeloNegociosUnidad2Page;
