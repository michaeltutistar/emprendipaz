...
const LiderazgoUnidad2InicioPage = () => {
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Liderazgo Visionario</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En la unidad 1 estudiamos 5 tipos de liderazgo y concluimos que cada persona posee uno predominante. Sin embargo, existe un tipo de liderazgo que recoge todas las características ideales que debería tener un líder: el <strong>liderazgo visionario</strong>.

            </p>

            <p className="text-gray-700 leading-relaxed">

              El liderazgo visionario es uno de los estilos más impactantes porque conecta profundamente con las emociones, aspiraciones y valores del equipo de trabajo. El líder visionario no solo dirige, sino que además inspira a través de una visión clara, atractiva y compartida.
...
export default LiderazgoUnidad2InicioPage;
