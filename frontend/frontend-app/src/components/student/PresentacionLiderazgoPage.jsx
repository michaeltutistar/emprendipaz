...
import GlosarioLiderazgoModal from './GlosarioLiderazgoModal';

import BibliografiaLiderazgoModal from './BibliografiaLiderazgoModal';
...
const PresentaciónLiderazgoPage = () => {
  ...
  const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Liderazgo');
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#006837] via-[#00844a] to-[#59D22E]">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Liderazgo</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-white text-sm font-medium">MÓDULO 10</span>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  descripcion="Identifica tu estilo de liderazgo predominante y aprende sobre los 5 estilos más comunes: autoritario, democrático, afiliativo, timonel y coaching."
                  estaCompletada={unidad1Completada}
                  estaDisponible={unidadesDisponibles[1] ?? true}
                  unidadAnteriorCompletada={true}
                  ruta="/student/liderazgo/unidad1/inicio"
                  delay={0.1}
                ...
                <UnidadCard
                  ...
                  unidadNumero={2}
                  titulo="Liderazgo Visionario"
                  descripcion="Descubre las características del liderazgo visionario y cómo inspirar a tu equipo a través de una visión clara y compartida."
                  estaCompletada={unidad2Completada}
                  estaDisponible={unidadesDisponibles[2] ?? false}
                  unidadAnteriorCompletada={unidad1Completada}
                  ruta="/student/liderazgo/unidad2/inicio"
                  delay={0.2}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
                ...
                <UnidadCard
                  ...
                  descripcion="Aprende una metodología práctica de 4 pasos para tomar decisiones efectivas que construyan confianza y movilicen a tu equipo."
                  estaCompletada={unidad3Completada}
                  estaDisponible={unidadesDisponibles[3] ?? false}
                  unidadAnteriorCompletada={unidad2Completada}
                  ruta="/student/liderazgo/unidad3/inicio"
                  delay={0.3}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/liderazgo/plan-negocio')}
      ...
      {showBibliografia && <BibliografiaLiderazgoModal onClose={() => setShowBibliografia(false)} />}

      {showGlosario && <GlosarioLiderazgoModal onClose={() => setShowGlosario(false)} />}
...
export default PresentaciónLiderazgoPage;
