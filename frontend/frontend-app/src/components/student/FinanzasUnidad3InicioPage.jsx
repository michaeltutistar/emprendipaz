...
const FinanzasUnidad3InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/finanzas/unidad3/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-2 text-white/80 mb-6 text-sm">
              ...
              <span className="text-white font-semibold">Unidad 3 · Gestión Empresarial</span>
...
<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            >
              ...
              Gestión Empresarial · Presentación
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              La gestión empresarial en los negocios constituye un conjunto de prácticas orientadas a organizar, dirigir y controlar de manera 

              eficiente los recursos disponibles para asegurar el crecimiento de la empresa. En este tipo de organizaciones, la toma de decisiones 

              suele recaer directamente en el propietario o en el grupo familiar, de esta manera la administración efectiva resulta determinante 

              para enfrentar entornos competitivos y cambiantes.

            </p>

            <p className="text-gray-700 leading-relaxed">

              La gestión empresarial también implica optimizar recursos limitados, mejorar procesos y fortalecer la relación con clientes y 

              proveedores. Asimismo, el control y seguimiento de los activos, pasivos y patrimonio, unido al presupuesto de ventas facilita 

              tomar decisiones oportunas y corregir desviaciones.
...
export default FinanzasUnidad3InicioPage;
