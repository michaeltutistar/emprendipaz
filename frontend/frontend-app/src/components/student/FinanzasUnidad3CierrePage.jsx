...
const preguntas = [

  {
    ...
    pregunta: 'La estrategia de gestión que se centra en establecer objetivos y estrategias es:',

    opciones: [

      { id: 'a', texto: 'Organización' },

      { id: 'b', texto: 'Planificación' },
...

  {
    ...
    pregunta: 'Cuando un gerente distribuye recursos y asigna responsabilidades, está aplicando:',

    opciones: [

      { id: 'a', texto: 'Organización' },

      { id: 'b', texto: 'Dirección' },

      { id: 'c', texto: 'Planificación' }
...

  {
    ...
    pregunta: 'Motivar al equipo de trabajo corresponde a la función de:',
...

  {
    ...
    pregunta: 'Evaluar resultados y tomar medidas correctivas es parte de:',

    opciones: [

      { id: 'a', texto: 'Control' },

      { id: 'b', texto: 'Organización' },

      { id: 'c', texto: 'Dirección' }
...

  {
    ...
    pregunta: 'La gestión empresarial busca principalmente:',

    opciones: [

      { id: 'a', texto: 'Incrementar costos' },

      { id: 'b', texto: 'Optimizar recursos y alcanzar objetivos' },

      { id: 'c', texto: 'Evitar la planificación' }
...
const FinanzasUnidad3CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Finanzas y Gestión Empresarial', 'Unidad 3: Evaluación');
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">Unidad 3 · Evaluación</span>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            >
              ...
              Gestión Empresarial · Evaluación
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
          ...
          <div className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-neutral-900 mb-2">Evaluación: Gestión Empresarial</h2>

            <div className="bg-neutral-100 border-l-4 border-green-400/80 p-4 rounded">

              <p className="text-neutral-700 text-sm md:text-base">

                Para cerrar la Unidad 3: "Estrategias de gestión administrativa", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default FinanzasUnidad3CierrePage;
