...
const ModeloNegociosUnidad2InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Modelo de Negocios', 'Unidad 2: Presentación');
...
// Sincronizar botón con progreso ya guardado
...
const handleCompleteStep = async () => {
    // Registrar progreso usando el hook (ya registra en backend)
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Análisis de Segmentos, Canales y Propuesta de Valor</span>
...
{/* Title */}
          ...
          >
            ...
            >
              ...
              Análisis de Segmentos, Canales y Propuesta de Valor
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad profundizarás en tres elementos clave del Business Model Canvas: la segmentación de clientes, 

              la gestión de canales y la propuesta de valor.

            </p>

            <p className="text-gray-700 leading-relaxed">

              Aprenderás a identificar y caracterizar tus segmentos de mercado, a diseñar y optimizar tus canales de comunicación 

              y entrega, y a validar tu propuesta de valor.
...
export default ModeloNegociosUnidad2InicioPage;
