...
const PlanInversionUnidad3InicioPage = () => {
    ...
    try {
      ...
      await fetch(`${API_BASE_URL}/registrar-progreso-modulo`, {
        ...
        body: JSON.stringify({
          ...
          paso_nombre: 'Unidad 3: Presentación',
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Gestión y Evaluación de Proyectos de Inversión</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás a formular un plan de inversión completo, estructurando un documento formal que sirva como 

              instrumento de comunicación, gestión y control. También aprenderás a implementar el plan y realizar seguimiento, 

              identificando cuándo y cómo hacer ajustes y replanificación.

            </p>

            <p className="text-gray-700 leading-relaxed">

              Esta unidad te prepara para transformar tus ideas de inversión en planes concretos y ejecutables, con herramientas 

              prácticas para la gestión y evaluación continua.
...
export default PlanInversionUnidad3InicioPage;
