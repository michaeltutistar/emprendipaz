...
const preguntas = [

  {
    ...
    pregunta: '¿Cuál es el propósito principal del liderazgo?',

    opciones: [

      { id: 'A', texto: 'Controlar las tareas del equipo para evitar errores.' },

      { id: 'B', texto: 'Convocar, dirigir, motivar y evaluar al equipo para lograr objetivos.' },

      { id: 'C', texto: 'Supervisar constantemente el cumplimiento de metas.' }
...

  {
    ...
    pregunta: '¿Cuál de los siguientes se considera un enemigo del liderazgo?',

    opciones: [

      { id: 'A', texto: 'Delegar tareas en el equipo.' },

      { id: 'B', texto: 'Reconocer los errores del proyecto.' },

      { id: 'C', texto: 'No inspirar desde el ejemplo.' }
...

  {
    ...
    pregunta: '¿Qué caracteriza al liderazgo afiliativo?',

    opciones: [

      { id: 'A', texto: 'Se enfoca en la eficiencia operativa y el control.' },

      { id: 'B', texto: 'Prioriza el bienestar emocional del equipo de trabajo.' },

      { id: 'C', texto: 'Se basa en la toma de decisiones personales.' }
...

  {
    ...
    pregunta: '¿En qué situación es más adecuado aplicar el liderazgo autoritario?',

    opciones: [

      { id: 'A', texto: 'Cuando el equipo de trabajo está emocionalmente afectado.' },

      { id: 'B', texto: 'En situaciones críticas que requieren control inmediato.' },

      { id: 'C', texto: 'Cuando se busca fomentar la creatividad.' }
...

  {
    ...
    pregunta: '¿Qué distingue al liderazgo coaching de los demás estilos?',

    opciones: [

      { id: 'A', texto: 'Se basa en la supervisión constante del equipo.' },

      { id: 'B', texto: 'Promueve el aprendizaje continuo y la mejora autónoma.' },

      { id: 'C', texto: 'Se limita a tareas operativas y seguimiento estricto.' }
...
const LiderazgoUnidad1CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Liderazgo', 'Unidad 1: Evaluación');
...
{/* Instrucciones al lado del título */}
          ...
          <div className="bg-gradient-to-r from-[#AA27B9]/10 to-[#d946ef]/10 border-l-3 border-[#AA27B9] rounded-xl p-2.5 flex-1 max-w-md">
            ...
            <p className="text-gray-700 leading-snug text-xs">
              ...
              <strong>📌 Instrucciones:</strong> Para cerrar la unidad 1 "Estilos de Liderazgo", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default LiderazgoUnidad1CierrePage;
