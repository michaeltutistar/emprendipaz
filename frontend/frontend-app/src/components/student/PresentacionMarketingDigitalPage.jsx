...
const PresentaciónMarketingDigitalPage = () => {
...
// Usar hook personalizado para cargar progreso desde backend
  ...
  } = useModuleProgress('Marketing Digital');
...
// NO usar localStorage para progreso - es compartido entre usuarios.
...
const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Marketing Digital');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Marketing Digital</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-white text-sm font-medium">MÓDULO 5</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo5/M5INTRO-.mp4"

                    poster="/Modulo5/screeninicio.jpg"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  titulo="Diagnóstico de Presencia Digital"

                  descripcion="Elabora un diagnóstico mediante una metodología de 5 pasos que te facilite la comprensión del estado actual de la presencia digital de tu emprendimiento."
                  ...
                  ruta="/student/marketing-digital/unidad1"
...
{/* Unidad 2 */}
                ...
                <UnidadCard
                  ...
                  titulo="Metas de Marketing Digital"

                  descripcion="Define metas claras de marketing digital basadas en el diagnóstico realizado. Aprende la metodología SMART para establecer objetivos medibles y alcanzables."
                  ...
                  ruta="/student/marketing-digital/unidad2"
...
{/* Unidad 3 */}
                ...
                <UnidadCard
                  ...
                  descripcion="Desarrolla estrategias de marketing digital que respondan a las necesidades del negocio. Aprende sobre las ventajas de implementar estrategias digitales y cómo desarrollarlas."
                  ...
                  ruta="/student/marketing-digital/unidad3"
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/marketing-digital/plan-negocio')}
...
export default PresentaciónMarketingDigitalPage;
