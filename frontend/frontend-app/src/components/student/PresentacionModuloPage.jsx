...
import { Play, ChevronRight, FileText, UserCheck, Award, BookMarked, BookOpen, ArrowLeft, Home, ArrowDown, ChevronDown, LogOut } from 'lucide-react';
...
import BibliografiaMarketingComercializacionModal from './BibliografiaMarketingComercializacionModal';
...
// Usar hook personalizado para cargar progreso desde backend
  ...
  } = useModuleProgress('Marketing y Comercialización');
...
// Sincronizar con estado local
  ...
  const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Marketing y Comercialización');
...
// Scroll to "Comencemás" section on mount if coming from completion
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Marketing y Comercialización</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-white text-sm font-medium">MÓDULO 4</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo4/M4INTRO.mp4"

                    poster="/Modulo4/screeninicio.jpg"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  unidadNumero={1}
                  titulo="Caracterización interna y externa"
                  descripcion="Aplica la matriz DOFA para reconocer el estado actual del emprendimiento y entender su entorno."
                  estaCompletada={unidad1Completada}
                  estaDisponible={unidadesDisponibles[1] ?? true}
                  unidadAnteriorCompletada={true}
                  ruta="/student/unidad1"
                  delay={0.1}
                ...
                <UnidadCard
                  ...
                  unidadNumero={2}
                  titulo="Bases del direccionamiento estratégico"
                  descripcion="Diseña misión, visión y estrategias que conecten la realidad del negocio con el futuro deseado."
                  estaCompletada={unidad2Completada}
                  estaDisponible={unidadesDisponibles[2] ?? false}
                  unidadAnteriorCompletada={unidad1Completada}
                  ruta="/student/unidad2/inicio"
                  delay={0.2}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
                ...
                <UnidadCard
                  ...
                  unidadNumero={3}
                  titulo="Estrategias de comercialización"
                  descripcion="Aplica el marketing mix (Producto, Precio, Plaza y Promoción) con ejemplos y casos reales."
                  estaCompletada={unidad3Completada}
                  estaDisponible={unidadesDisponibles[3] ?? false}
                  unidadAnteriorCompletada={unidad2Completada}
                  ruta="/student/unidad3/inicio"
                  delay={0.3}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/presentacion-modulo/plan-negocio')}
...
{/* Modals */}
      ...
      {showBibliografia && <BibliografiaMarketingComercializaciónModal onClose={() => setShowBibliografia(false)} />}
...
export default PresentaciónModuloPage;
