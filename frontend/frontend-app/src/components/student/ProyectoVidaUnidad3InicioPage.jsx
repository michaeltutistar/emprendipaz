...
const ProyectoVidaUnidad3InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Proyecto de vida', 'Unidad 3: Presentación');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <button onClick={() => navigate('/student/proyecto-vida')} className="hover:text-white transition-colors">
              ...
              <span className="text-white font-semibold">Plan de acción del proyecto de vida</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Esta unidad presenta los "Fundamentos sobre plan de acción del proyecto de vida".

              El plan de acción consiste en organizar metas y acciones de manera coherente, asignando recursos y tiempos específicos.

            </p>

            <p className="text-gray-700 leading-relaxed">

              Este proceso permite anticipar dificultades, priorizar actividades y mantener la coherencia entre lo que se quiere y lo que se hace.
...
export default ProyectoVidaUnidad3InicioPage;
