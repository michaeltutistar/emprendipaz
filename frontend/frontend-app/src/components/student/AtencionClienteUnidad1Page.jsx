...
const AtencionClienteUnidad1Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/atencion-cliente/unidad1/inicio',

      descripcion: 'Video y contexto de la unidad sobre ciclo del servicio'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad1/desarrollo',

      descripcion: 'Fundamentos sobre atención al cliente, ciclo del servicio con 11 pasos y momentos de verdad'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad1/taller',

      descripcion: 'Mapea el ciclo del servicio emparejando situaciones prácticas con los pasos correspondientes'
...

    {
      ...
      ruta: '/student/atencion-cliente/unidad1/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre ciclo del servicio'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 1: Ciclo del Servicio</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás sobre la importancia de la atención al cliente y comprenderás el ciclo completo del servicio, que incluye 11 pasos desde la expectativa inicial hasta el post-servicio.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                También conocerás los "momentos de verdad", esos instantes clave donde el cliente forma una percepción inmediata sobre la calidad del servicio.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/atencion-cliente/unidad1/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los fundamentos sobre atención al cliente, el ciclo del servicio con sus 11 pasos, los momentos de verdad y un caso de estudio práctico.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad1/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica tus conocimientos mapeando el ciclo del servicio. Empareja las situaciones prácticas con los pasos correspondientes del ciclo.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad1/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre ciclo del servicio antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/atencion-cliente/unidad1/cierre')}
...
export default AtencionClienteUnidad1Page;
