...
const FinanzasUnidad3Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/finanzas/unidad3/inicio',

      descripcion: 'Video y contexto de la unidad sobre gestión empresarial'
...

    {
      ...
      ruta: '/student/finanzas/unidad3/desarrollo',

      descripcion: 'Definiciones clave, ejemplos y casos prácticos de gestión empresarial'
...

    {
      ...
      ruta: '/student/finanzas/unidad3/taller',

      descripcion: 'Empareja situaciones del negocio con conceptos de gestión empresarial'
...

    {
      ...
      ruta: '/student/finanzas/unidad3/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre gestión empresarial'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 3: Gestión Empresarial</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás sobre gestión empresarial y cómo organizar eficientemente los recursos y procesos de tu emprendimiento.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                La gestión empresarial constituye un conjunto de prácticas orientadas a organizar, dirigir y controlar de manera eficiente los recursos 

                disponibles para asegurar el crecimiento de la empresa.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/finanzas/unidad3/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás las definiciones clave de gestión empresarial, ejemplos prácticos y casos de estudio.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad3/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica tus conocimientos emparejando situaciones del negocio con los conceptos de gestión empresarial correspondientes.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad3/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre gestión empresarial antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad3/cierre')}
...
export default FinanzasUnidad3Page;
