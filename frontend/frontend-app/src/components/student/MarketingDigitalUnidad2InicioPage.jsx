...
const MarketingDigitalUnidad2InicioPage = () => {

  const navigate = useNavigate();

  const [videoInView, setVideoInView] = useState(false);

  const [videoMarkedAsSeen, setVideoMarkedAsSeen] = useState(false);
...
// Verificar si el video ya fue visto en está sesión

    const videoVisto = sessionStorage.getItem('md_unidad2_video_visto');
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/marketing-digital/unidad2/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Metas de Marketing Digital</span>
              ...
              <video
                ...
                onTimeUpdate={() => {
                  ...
                  if (videoRef.current) {
                    ...
                    // Si el progreso alcanza el 100% (o muy cerca, considerando posibles errores de redondeo)

                    if (progress >= 99.5 || video.currentTime >= video.duration - 0.5) {

                      if (!videoMarkedAsSeen) {

                        setVideoMarkedAsSeen(true);

                        sessionStorage.setItem('md_unidad2_video_visto', 'true');
...
export default MarketingDigitalUnidad2InicioPage;
