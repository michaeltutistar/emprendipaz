...
import { ChevronRight, Home, ArrowLeft, BookOpen, BookMarked, ArrowDown } from 'lucide-react';

import { motion } from 'framer-motion';

import Footer from '../Footer';

import BibliografiaPlanInversionModal from './BibliografiaPlanInversionModal';

import GlosarioPlanInversionModal from './GlosarioPlanInversionModal';
...
const PresentaciónPlanInversionPage = () => {
  ...
  } = useModuleProgress('Plan de Inversión');
  ...
  const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Plan de Inversión');
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#006837] via-[#00844a] to-[#59D22E]">
      ...
      {/* Hero Section - Modulo con Introducción al lado */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Plan de Inversión</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-white text-sm font-medium">MÓDULO 9</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo9/M9INTRO.mp4"

                    poster="/Modulo9/screeninicio.jpg"
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  unidadNumero={1}
                  titulo="Fundamentación Teórica del Plan de Inversión"
                  descripcion="Comprende los conceptos clave del plan de inversión, sus componentes y su importancia en el proceso de formalización empresarial."
                  estaCompletada={unidad1Completada}
                  estaDisponible={unidadesDisponibles[1] ?? true}
                  unidadAnteriorCompletada={true}
                  ruta="/student/plan-inversion/unidad1/inicio"
                  delay={0.1}
                ...
                <UnidadCard
                  ...
                  unidadNumero={2}
                  titulo="Análisis y Estructura Financiera del Plan de Inversión"
                  descripcion="Aprende a analizar las necesidades de inversión, identificar fuentes de financiamiento y proyectar flujos de caja para evaluar la viabilidad financiera."
                  estaCompletada={unidad2Completada}
                  estaDisponible={unidadesDisponibles[2] ?? false}
                  unidadAnteriorCompletada={unidad1Completada}
                  ruta="/student/plan-inversion/unidad2/inicio"
                  delay={0.2}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
                ...
                <UnidadCard
                  ...
                  unidadNumero={3}
                  titulo="Gestión y Evaluación de Proyectos de Inversión"
                  descripcion="Te enfocarás en la gestión y evaluación de proyectos de inversión, asegurando que tus recursos se utilicen de manera eficiente para alcanzar tus objetivos."
                  estaCompletada={unidad3Completada}
                  estaDisponible={unidadesDisponibles[3] ?? false}
                  unidadAnteriorCompletada={unidad2Completada}
                  ruta="/student/plan-inversion/unidad3/inicio"
                  delay={0.3}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
      ...
      {showBibliografia && <BibliografiaPlanInversionModal onClose={() => setShowBibliografia(false)} />}

      {showGlosario && <GlosarioPlanInversionModal onClose={() => setShowGlosario(false)} />}
...
export default PresentaciónPlanInversionPage;
