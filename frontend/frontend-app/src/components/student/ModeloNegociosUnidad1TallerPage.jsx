...
const elementosCanvas = [
  ...
  { id: 'segmento-clientes', nombre: 'Segmento de clientes' },

  { id: 'propuesta-valor', nombre: 'Propuesta de valor' },

  { id: 'canales', nombre: 'Canales' },

  { id: 'relacion-clientes', nombre: 'Relación con clientes' },

  { id: 'fuentes-ingresos', nombre: 'Fuentes de ingresos' },

  { id: 'recursos-clave', nombre: 'Recursos clave' },

  { id: 'actividades-clave', nombre: 'Actividades clave' },

  { id: 'asociaciones-clave', nombre: 'Asociaciones clave' },

  { id: 'estructura-costos', nombre: 'Estructura de costos' }

];

// Descripciones para arrastrar (ordenado diferente a elementosCanvas para evitar ventaja)
...
const descripciones = [

  {
    ...
    texto: 'Señala los activos esenciales (humanos, tecnológicos, financieros, físicos)',

    respuestaCorrecta: 'recursos-clave'
...

  {
    ...
    texto: 'Muestra con quién se colabora para reducir riesgos y aprovechar oportunidades',

    respuestaCorrecta: 'asociaciones-clave'
...

  {
    ...
    texto: 'Define a quién se dirige la empresa y cuál es su público objetivo',

    respuestaCorrecta: 'segmento-clientes'
...

  {
    ...
    texto: 'Establece cómo se interactúa y se retiene a los clientes',

    respuestaCorrecta: 'relacion-clientes'
...

  {
    ...
    texto: 'Define las acciones críticas que permiten que el negocio funcione',

    respuestaCorrecta: 'actividades-clave'
...

  {
    ...
    texto: 'Explica qué problema resuelve y por qué los clientes eligen la empresa',

    respuestaCorrecta: 'propuesta-valor'
...

  {
    ...
    texto: 'Detalla los gastos principales, tanto fijos como variables',

    respuestaCorrecta: 'estructura-costos'
...

  {
    ...
    texto: 'Identifica cómo se generan los ingresos y cuál es el modelo de monetización',

    respuestaCorrecta: 'fuentes-ingresos'
...

  {
    ...
    texto: 'Describe cómo se llega al cliente y cómo se entrega el producto o servicio',

    respuestaCorrecta: 'canales'

  }

];

const ModeloNegociosUnidad1TallerPage = () => {
  ...
  const [respuestas, setRespuestas] = useState(() => {
    ...
    const saved = localStorage.getItem('modelo_negocios_u1_taller_respuestas');
  ...
  const [descripcionesDisponibles, setDescripcionesDisponibles] = useState(() => {
    ...
    const saved = localStorage.getItem('modelo_negocios_u1_taller_disponibles');
  ...
  const [validado, setValidado] = useState(() => {
    ...
    const saved = localStorage.getItem('modelo_negocios_u1_taller_validado');
...
useEffect(() => {
    ...
    localStorage.setItem('modelo_negocios_u1_taller_respuestas', JSON.stringify(respuestas));

  }, [respuestas]);

useEffect(() => {

    localStorage.setItem('modelo_negocios_u1_taller_disponibles', JSON.stringify(descripcionesDisponibles));

  }, [descripcionesDisponibles]);

useEffect(() => {

    localStorage.setItem('modelo_negocios_u1_taller_validado', validado.toString());
...
if (respuestas[elementoId]) {
      ...
      setDescripcionesDisponibles(prev => [...prev, respuestas[elementoId]]);
...
const handleReset = () => {
    ...
    localStorage.removeItem('modelo_negocios_u1_taller_respuestas');

    localStorage.removeItem('modelo_negocios_u1_taller_disponibles');

    localStorage.removeItem('modelo_negocios_u1_taller_validado');

  };

const todasRespondidas = Object.keys(respuestas).length === elementosCanvas.length;

  const respuestasCorrectasCount = elementosCanvas.filter(e => {

    const descripcionId = respuestas[e.id];

    const descripcion = descripciones.find(d => d.id === descripcionId);

    return descripcion && descripcion.respuestaCorrecta === e.id;
...
const esRespuestaCorrecta = (elementoId) => {
    ...
    return descripcion && descripcion.respuestaCorrecta === elementoId;
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/modelo-negocios/unidad1/cierre');
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            >
              ...
              Taller: identificando los bloques del modelo Canvas

            </h2>

            <p className="text-neutral-700 mb-4 text-sm md:text-base leading-relaxed">

              Ahora que ya conocemos el modelo Canvas, realizaremos el siguiente taller para reforzar conocimientos.
            ...
            <div className="bg-gradient-to-r from-[#AA27B9]/10 to-[#d946ef]/10 border-l-3 border-[#AA27B9] rounded-xl p-2.5 mb-6">
              ...
              <p className="text-gray-700 leading-snug text-xs">
                ...
                <strong>📌 Instrucción del taller:</strong> Arrastra la opción correcta de la columna Descripción hacia el espacio correspondiente en la columna Elemento del Canvas.
...
<div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Columna Izquierda: Elementos del Canvas */}

                <div>

                  <h4 className="font-semibold text-neutral-900 mb-4 text-center">Elemento del Canvas (arrastrar aquí)</h4>

                  <div className="space-y-3">

                    {elementosCanvas.map((elemento) => {
...
return (
                        ...
                        <div
                          ...
                          className={`
                            ...
                            ${dragOver === elemento.id ? 'border-[#AA27B9] bg-[#AA27B9]/10' : 'border-neutral-300'}
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="font-semibold text-neutral-900 mb-2">{elemento.nombre}</p>
                ...
                <div className="flex gap-4 items-center">
                  ...
                  {validado && (
                    ...
                    <div className="text-sm text-neutral-700">
                      ...
                      <span className="font-semibold">Resultado:</span> {respuestasCorrectasCount} de {elementosCanvas.length} correctas
                  ...
                  {validado && respuestasCorrectasCount === elementosCanvas.length && (
...
{/* Texto Final */}
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border-l-4 border-green-600 p-6 rounded-lg">
            ...
            <p className="text-neutral-700 text-center text-base md:text-lg italic">
              ...
              Un modelo de negocios claro es la brújula que convierte ideas en empresas sostenibles.
      ...
      <div className="fixed bottom-8 left-8 z-40">
        ...
        <Button
          ...
          onClick={() => {
            ...
            navigate('/student/modelo-negocios/unidad1/desarrollo');
...
export default ModeloNegociosUnidad1TallerPage;
