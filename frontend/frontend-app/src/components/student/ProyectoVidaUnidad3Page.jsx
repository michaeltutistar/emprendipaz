...
const ProyectoVidaUnidad3Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/proyecto-vida/unidad3/inicio',

      descripcion: 'Video y contexto de la unidad sobre plan de acción del proyecto de vida'
...

    {
      ...
      ruta: '/student/proyecto-vida/unidad3/desarrollo',

      descripcion: 'Fundamentos sobre plan de acción, elementos, importancia y casos de estudio'
...

    {
      ...
      ruta: '/student/proyecto-vida/unidad3/taller',

      descripcion: 'Empareja elementos del plan de acción con ejemplos'
...

    {
      ...
      ruta: '/student/proyecto-vida/unidad3/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre la unidad'
  ...
  const handleStepClick = (step) => {
    ...
    // Todas las unidades habilitadas para revisión
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <p className="text-xs tracking-wide mb-1 opacity-80">MÓDULO: Proyecto de vida</p>

          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 3: Plan de acción del proyecto de vida</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Empezaremos organizando metas y acciones de manera coherente, asignando recursos y tiempos específicos. Este paso te permitirá anticipar dificultades, priorizar actividades y mantener la coherencia entre lo que quieres y lo que haces.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Verás el video introductorio y revisarás los fundamentos sobre plan de acción del proyecto de vida antes de continuar con el taller.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/proyecto-vida/unidad3/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los fundamentos sobre plan de acción del proyecto de vida, sus elementos, importancia y casos de estudio prácticos.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/proyecto-vida/unidad3/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Llevarás la teoría a la práctica emparejando elementos del plan de acción con ejemplos. Arrastra cada ejemplo hacia el elemento correspondiente.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/proyecto-vida/unidad3/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre plan de acción del proyecto de vida antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/proyecto-vida/unidad3/cierre')}
...
export default ProyectoVidaUnidad3Page;
