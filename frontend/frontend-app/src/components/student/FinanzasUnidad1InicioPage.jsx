...
const FinanzasUnidad1InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/finanzas/unidad1/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-2 text-white/80 mb-6 text-sm">
              ...
              <span className="text-white font-semibold">Unidad 1 · Estudio de la ecuación patrimonial</span>
...
<motion.div
          ...
          >
            ...
            >
              ...
              Estudio de la ecuación patrimonial · Presentación
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              La contabilidad es fundamental porque permite registrar y comprender las operaciones económicas de una empresa. Con esta información, 

              los emprendedores evalúan los recursos, costos, obligaciones y resultados (utilidad o pérdida). La gestión empresarial utiliza estos 

              datos para planear, organizar y controlar las actividades, tomando decisiones responsables. Tanto las finanzas como la gestión empresarial 

              fortalecen la estabilidad de todo negocio.
...
export default FinanzasUnidad1InicioPage;
