...
const preguntas = [

  {
    ...
    pregunta: '¿Qué es lo primero que debes hacer al atender a un cliente difícil?',

    opciones: [

      { id: 'A', texto: 'Responder rápido sin pensar' },

      { id: 'B', texto: 'Escuchar con atención' },

      { id: 'C', texto: 'Ofrecer un descuento inmediato' }
...

  {
    ...
    pregunta: '¿Cómo se debe orientar a un cliente indeciso?',

    opciones: [

      { id: 'A', texto: 'Darle muchas opciones sin explicarlas' },

      { id: 'B', texto: 'Explicar con palabras simples y confirmar acuerdos' },

      { id: 'C', texto: 'Dejar que decida solo, sin apoyo' }
...

  {
    ...
    pregunta: '¿Qué actitud es adecuada frente a un cliente perfeccionista?',

    opciones: [

      { id: 'A', texto: 'Agradecer su cuidado en los detalles y ajustar la calidad del producto o servicio' },

      { id: 'B', texto: 'Evitar cambios para no perder tiempo' },

      { id: 'C', texto: 'Decir que "así está bien"' }
...

  {
    ...
    pregunta: '¿Qué ayuda a recuperar la confianza de un cliente insatisfecho recurrente?',

    opciones: [

      { id: 'A', texto: 'Minimizar sus quejas' },

      { id: 'B', texto: 'Tratarlo como si fuera cliente nuevo' },

      { id: 'C', texto: 'Reconocer sus quejas anteriores, mostrar mejoras y dar seguimiento' }
...

  {
    ...
    pregunta: '¿Qué necesita un cliente silencioso o poco expresivo?',

    opciones: [

      { id: 'A', texto: 'Mensajes largos y técnicos' },

      { id: 'B', texto: 'Preguntas abiertas y un ambiente de confianza' },

      { id: 'C', texto: 'Finalizar rápido la atención' }
...
const AtencionClienteUnidad3CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Atención al Cliente y Resolución de Conflictos', 'Unidad 3: Evaluación');
...
<motion.div
          ...
          >
            ...
            >
              ...
              Resolución de Conflictos y Manejo de Clientes Difíciles · Evaluación

            </h1>

            <p className="text-white/80 max-w-2xl text-sm md:text-base mb-8">

              Evalúa tus conocimientos sobre canales oficiales de atención y estrategias para manejar diferentes tipos de clientes difíciles.
            ...
            {evaluaciónBloqueada ? (
              ...
              <div className="bg-neutral-100 border-l-4 border-neutral-900 p-4 rounded">
                ...
                <p className="text-neutral-700 text-sm md:text-base">
                  ...
                  Para cerrar la Unidad 3: "Resolución de conflictos y manejo de clientes difíciles", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
<div className="fixed bottom-8 left-4 md:left-8 z-40">
        ...
        <Button
          ...
          onClick={() => navigate('/student/atencion-cliente/unidad3')}
...
export default AtencionClienteUnidad3CierrePage;
