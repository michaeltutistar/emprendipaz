...
const MarketingDigitalUnidad3InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/marketing-digital/unidad3/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Estrategias de Marketing Digital</span>
                  ...
                  if (videoRef.current) {
                    ...
                    if (progress >= 99.5 || video.currentTime >= video.duration - 0.5) {
                      ...
                      if (!videoMarkedAsSeen) {
                        ...
                        sessionStorage.setItem('md_unidad3_video_visto', 'true');
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Las estrategias de marketing digital son acciones planificadas que responden a las necesidades del negocio y permiten aprovechar las ventajas de los medios digitales para alcanzar las metas establecidas.
...
export default MarketingDigitalUnidad3InicioPage;
