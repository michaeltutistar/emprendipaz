...
const MarketingDigitalUnidad3Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/marketing-digital/unidad3/inicio',

      descripcion: 'Video y contexto de la unidad sobre estrategias de marketing digital'
...

    {
      ...
      ruta: '/student/marketing-digital/unidad3/desarrollo',

      descripcion: 'Estrategias de marketing digital y ventajas de implementarlas'
...

    {
      ...
      ruta: '/student/marketing-digital/unidad3/taller',

      descripcion: 'Desarrolla estrategias de marketing digital para tu emprendimiento'
...

    {
      ...
      ruta: '/student/marketing-digital/unidad3/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre estrategias de marketing digital'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 3: Estrategias de Marketing Digital</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En la unidad 2 "Metas de marketing digital", definimos los objetivos para nuestro plan de marketing digital. Ahora, en la unidad final, es momento de desarrollar la estrategia adecuada para alcanzar esos objetivos.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/marketing-digital/unidad3/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás qué es una estrategia de marketing digital, sus ventajas y cómo desarrollarlas para alcanzar los objetivos definidos.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/marketing-digital/unidad3/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Desarrolla estrategias de marketing digital específicas para tu emprendimiento, alineadas con los objetivos SMART que definiste en la unidad anterior.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/marketing-digital/unidad3/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre estrategias de marketing digital antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/marketing-digital/unidad3/cierre')}
...
export default MarketingDigitalUnidad3Page;
