...
const DescubrimientoUnidad1InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Descubrimiento de Oportunidades', 'Unidad 1: Presentación');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Diagnóstico Estratégico</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              El diagnóstico estratégico se constituye como una herramienta de gestión eficaz para impulsar crecimiento, 

              propiciar su adaptación a los cambios del entorno y fortalecer sus ventajas competitivas. Su implementación 

              permite definir las acciones a realizar para alcanzar su futuro deseado.

            </p>

            <p className="text-gray-700 leading-relaxed">

              En está unidad aprenderás sobre el análisis del macroentorno mediante la herramienta PESTEL, que analiza 

              factores políticos, económicos, sociales, tecnológicos, ecológicos y legales para identificar oportunidades 

              y amenazas en el entorno de tu emprendimiento.
...
export default DescubrimientoUnidad1InicioPage;
