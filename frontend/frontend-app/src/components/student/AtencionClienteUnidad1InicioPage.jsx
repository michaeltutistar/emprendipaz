...
const AtencionClienteUnidad1InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/atencion-cliente/unidad1/desarrollo');
                  ...
                  if (videoRef.current) {
                    ...
                    if (progress >= 99.5 || video.currentTime >= video.duration - 0.5) {
                      ...
                      if (!videoMarkedAsSeen) {
                        ...
                        sessionStorage.setItem('ac_unidad1_video_visto', 'true');
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás sobre la importancia de la atención al cliente y comprenderás el ciclo completo del servicio.

              El ciclo del servicio es la secuencia completa de interacciones, percepciones y procesos que un cliente experimenta antes,

              durante y después de recibir un servicio.

            </p>

            <p className="text-gray-700 leading-relaxed">

              También conocerás los "momentos de verdad", esos instantes clave donde el cliente entra en contacto directo o indirecto

              con la empresa y forma una percepción inmediata sobre la calidad del servicio.
...
export default AtencionClienteUnidad1InicioPage;
