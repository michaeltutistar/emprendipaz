...
const preguntas = [

  {
    ...
    pregunta: '¿Qué se entiende por atención al cliente en una empresa?',

    opciones: [

      { id: 'A', texto: 'El conjunto de acciones para vender más productos.' },

      { id: 'B', texto: 'La publicidad que se hace en redes sociales.' },

      { id: 'C', texto: 'Las estrategias para asistir, orientar y resolver necesidades de los clientes antes, durante y después de la compra.' }
...

  {
    ...
    pregunta: '¿Por qué la atención al cliente es clave en un emprendimiento?',

    opciones: [

      { id: 'A', texto: 'Porque garantiza que no haya reclamaciones.' },

      { id: 'B', texto: 'Porque permite diferenciarse de la competencia y fidelizar clientes.' },

      { id: 'C', texto: 'Porque elimina la necesidad de invertir en marketing digital.' }
...

  {
    ...
    pregunta: '¿Qué representa el ciclo del servicio?',

    opciones: [

      { id: 'A', texto: 'La secuencia completa de interacciones, percepciones y procesos que vive el cliente antes, durante y después del servicio.' },

      { id: 'B', texto: 'El plan de ventas trimestral de la organización.' },

      { id: 'C', texto: 'El conjunto de pasos internos de producción de la empresa.' }
...

  {
    ...
    pregunta: '¿Cuál de los siguientes es un ejemplo de "momento de verdad"?',

    opciones: [

      { id: 'A', texto: 'La planeación de inventarios en bodega.' },

      { id: 'B', texto: 'La manera de explicar precios o disponibilidad.' },

      { id: 'C', texto: 'El cálculo de costos internos de la empresa.' }
...

  {
    ...
    pregunta: '¿Qué conclusión se desprende del caso de Eco-Ágil?',

    opciones: [

      { id: 'A', texto: 'Que el servicio termina en la entrega del producto.' },

      { id: 'B', texto: 'Que la publicidad es más importante que la experiencia del cliente.' },

      { id: 'C', texto: 'Que cada interacción, por pequeña que sea, construye o destruye la percepción del cliente.' }
...
const AtencionClienteUnidad1CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Atención al Cliente y Resolución de Conflictos', 'Unidad 1: Evaluación');
...
<motion.div
          ...
          >
            ...
            >
              ...
              Ciclo del Servicio · Evaluación

            </h1>

            <p className="text-white/80 max-w-2xl text-sm md:text-base mb-8">

              Evalúa tus conocimientos sobre el ciclo del servicio y los momentos de verdad.
            ...
            {evaluaciónBloqueada ? (
              ...
              <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded mb-4">
                ...
                <p className="text-green-800 font-semibold">
                  ...
                  ✅ Ya completaste esta evaluación correctamente. No puedes volver a realizarla.
              ...
              <div className="bg-neutral-100 border-l-4 border-neutral-900 p-4 rounded">
                ...
                <p className="text-neutral-700 text-sm md:text-base">
                  ...
                  Para cerrar la unidad 1 "Ciclo del Servicio", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
<div className="flex justify-end gap-4 mt-8">
            ...
            {!mostrarResultado && !evaluaciónBloqueada ? (
              ...
              <Button
                ...
                disabled={!todasRespondidas || enviandoIntento || cargandoEstado}

                className={`px-8 py-4 flex items-center gap-2 ${(!todasRespondidas || enviandoIntento || cargandoEstado)
...
export default AtencionClienteUnidad1CierrePage;
