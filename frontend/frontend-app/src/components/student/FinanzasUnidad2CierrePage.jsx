...
const preguntas = [

  {
    ...
    pregunta: '¿Qué es un presupuesto de ventas?',

    opciones: [

      { id: 'A', texto: 'Un cálculo de gastos futuros' },

      { id: 'B', texto: 'Una estimación de las ventas esperadas en un periodo' },

      { id: 'C', texto: 'Un registro de ventas pasadas' }
...

  {
    ...
    pregunta: '¿Qué información se usa para preparar un presupuesto de ventas?',

    opciones: [

      { id: 'A', texto: 'Preferencias del gerente' },

      { id: 'B', texto: 'Datos históricos, precios y proyecciones de demanda' },

      { id: 'C', texto: 'Solo los costos del negocio' }
...

  {
    ...
    pregunta: '¿Cuál es el objetivo principal del presupuesto de ventas?',

    opciones: [

      { id: 'A', texto: 'Controlar inventarios' },

      { id: 'B', texto: 'Predecir ingresos futuros y planificar la producción' },

      { id: 'C', texto: 'Aumentar gastos' }
...

  {
    ...
    pregunta: 'Si se espera vender 500 unidades a $20 cada una, ¿cuál sería la proyección de ingresos?',
...

  {
    ...
    pregunta: '¿Qué factor puede afectar el presupuesto de ventas?',

    opciones: [

      { id: 'A', texto: 'Tendencias del mercado' },

      { id: 'B', texto: 'Color del local' },

      { id: 'C', texto: 'Tamaño del escritorio' }
        ...
        <div className="p-8 space-y-4">
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Felicitaciones! Has completado la Unidad 2 de Finanzas y Gestión Empresarial.
...
const FinanzasUnidad2CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Finanzas y Gestión Empresarial', 'Unidad 2: Evaluación');
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">Unidad 2 · Evaluación</span>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
          ...
          <div className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-neutral-900 mb-2">Evaluación: Preparación de presupuesto de ventas</h2>

            <div className="bg-neutral-100 border-l-4 border-green-400/80 p-4 rounded">

              <p className="text-neutral-700 text-sm md:text-base">

                Para cerrar la unidad 2 "Preparación de presupuesto de ventas", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default FinanzasUnidad2CierrePage;
