...
const Unidad3InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Marketing y Comercialización', 'Unidad 3: Inicio');
...
const handleCompleteStep = async () => {
    ...
    navigate('/student/unidad3/desarrollo');
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Esta unidad presenta las estrategias de comercialización y el marketing mix (las 4P: Producto, Precio, Plaza y Promoción).

              Aprenderás a aplicar estas herramientas estratégicas para posicionar tu empresa en el mercado.

            </p>

            <p className="text-gray-700 leading-relaxed">

              El marketing mix permite crear una estrategia integral que conecta tu propuesta de valor con las necesidades del mercado objetivo,

              facilitando la conexión entre el producto y el cliente para generar ventas.
...
export default Unidad3InicioPage;
