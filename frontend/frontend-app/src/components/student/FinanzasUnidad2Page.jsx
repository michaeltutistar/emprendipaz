...
const FinanzasUnidad2Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/finanzas/unidad2/inicio',

      descripcion: 'Video y contexto de la unidad sobre preparación de presupuesto de ventas'
...

    {
      ...
      ruta: '/student/finanzas/unidad2/desarrollo',

      descripcion: 'Conceptos sobre presupuesto de ventas y estudio de casos'
...

    {
      ...
      ruta: '/student/finanzas/unidad2/taller',

      descripcion: 'Ejercicios prácticos de presupuestos de ventas'
...

    {
      ...
      ruta: '/student/finanzas/unidad2/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre presupuesto de ventas'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 2: Preparación de presupuesto de ventas</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás sobre la preparación de presupuestos de ventas, que te permitirá proyectar ingresos futuros 

                y planificar mejor tu negocio.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/finanzas/unidad2/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás los conceptos sobre presupuesto de ventas y estudiarás casos prácticos.
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica tus conocimientos resolviendo ejercicios prácticos de presupuestos de ventas.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad2/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre presupuesto de ventas antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad2/cierre')}
...
export default FinanzasUnidad2Page;
