...
const preguntas = [

  {
    ...
    pregunta: '¿Cuál es el primer paso del protocolo de atención de quejas y reclamaciones?',

    opciones: [

      { id: 'A', texto: 'Verificar' },
...

  {
    ...
    pregunta: '¿Qué acción corresponde al paso de Verificar?',

    opciones: [

      { id: 'A', texto: 'Escuchar activamente al cliente' },

      { id: 'B', texto: 'Revisar el pedido y confirmar el tiempo de entrega' },

      { id: 'C', texto: 'Ofrecer una compensación' }
...

  {
    ...
    pregunta: 'En el paso Responder, la empresa debe:',

    opciones: [

      { id: 'A', texto: 'Justificar el error' },

      { id: 'B', texto: 'Registrar el caso en el sistema' },

      { id: 'C', texto: 'Ofrecer una solución clara y concreta' }
...

  {
    ...
    pregunta: '¿Qué se debe hacer en el paso Cerrar?',

    opciones: [

      { id: 'A', texto: 'Confirmar satisfacción y registrar el caso' },

      { id: 'B', texto: 'Agradecer la comunicación inicial' },

      { id: 'C', texto: 'Identificar el origen del error' }
...

  {
    ...
    pregunta: '¿Por qué es importante aplicar correctamente el protocolo de atención de quejas y reclamaciones?',

    opciones: [

      { id: 'A', texto: 'Para evitar cualquier error en el servicio' },

      { id: 'B', texto: 'Para transformar reclamaciones en oportunidades de fidelización' },

      { id: 'C', texto: 'Para reducir costos operativos' }
...
const AtencionClienteUnidad2CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Atención al Cliente y Resolución de Conflictos', 'Unidad 2: Evaluación');
            ...
            {evaluaciónBloqueada ? (
              ...
              <div className="bg-neutral-100 border-l-4 border-neutral-900 p-4 rounded">
                ...
                <p className="text-neutral-700 text-sm md:text-base">
                  ...
                  Para cerrar la Unidad 2: "Gestión de quejas y reclamaciones", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default AtencionClienteUnidad2CierrePage;
