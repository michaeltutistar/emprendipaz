...
const TrabajoEquipoUnidad3Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/trabajo-equipo/unidad3/inicio',

      descripcion: 'Video y contexto de la unidad sobre dificultades en el equipo de trabajo'
...

    {
      ...
      ruta: '/student/trabajo-equipo/unidad3/desarrollo',

      descripcion: 'Fundamentos sobre dificultades frecuentes y soluciones prácticas'
...

    {
      ...
      ruta: '/student/trabajo-equipo/unidad3/taller',

      descripcion: 'Empareja problemas con sus soluciones correspondientes'
...

    {
      ...
      ruta: '/student/trabajo-equipo/unidad3/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre dificultades en el equipo de trabajo'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 3: Dificultades en el Equipo de Trabajo</h1>
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás a identificar y resolver las dificultades comunes en los equipos de trabajo,

                aplicando estrategias prácticas para fomentar la confianza, el compromiso y la colaboración.
              ...
              <p className="text-neutral-600 mb-8 text-sm md:text-base">
                ...
                Esta diversidad puede generar dificultades si no se gestiona adecuadamente.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/trabajo-equipo/unidad3/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás las dificultades frecuentes en los equipos de trabajo y sus soluciones prácticas,

                basadas en las obras de Patrick Lencioni y Daniel Coyle.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/trabajo-equipo/unidad3/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica tus conocimientos emparejando cada problema con su solución correspondiente.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/trabajo-equipo/unidad3/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre dificultades en el equipo de trabajo antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/trabajo-equipo/unidad3/cierre')}
...
export default TrabajoEquipoUnidad3Page;
