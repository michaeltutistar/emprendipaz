...
const preguntas = [

  {
    ...
    pregunta: '¿Qué valor es esencial para generar confianza en un emprendimiento?',

    opciones: [

      { id: 'A', texto: 'Honestidad' },
...

  {
    ...
    pregunta: '¿Qué ocurre si un emprendedor carece de responsabilidad?',

    opciones: [

      { id: 'A', texto: 'Sus productos son más innovadores.' },

      { id: 'B', texto: 'Sus metas se cumplen más rápido.' },

      { id: 'C', texto: 'Sus decisiones pierden credibilidad.' }
...

  {
    ...
    pregunta: '¿Qué valor permite superar obstáculos y mantener la constancia?',

    opciones: [

      { id: 'A', texto: 'Solidaridad' },

      { id: 'B', texto: 'Perseverancia' },

      { id: 'C', texto: 'Innovación' }
...

  {
    ...
    pregunta: '¿Qué interés se relaciona con un emprendimiento de reciclaje?',

    opciones: [

      { id: 'A', texto: 'Arte' },

      { id: 'B', texto: 'Sostenibilidad ambiental' },
...

  {
    ...
    pregunta: '¿Qué valor fortalece la unión comunitaria en un emprendimiento?',

    opciones: [

      { id: 'A', texto: 'Innovación' },

      { id: 'B', texto: 'Honestidad' },

      { id: 'C', texto: 'Solidaridad' }
...
const ProyectoVidaUnidad1CierrePage = () => {
...
const { pasoCompletado, registrarProgreso } = useProgressTracking('Proyecto de vida', 'Unidad 1: Evaluación');
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              sobre valores e intereses personales.
...
export default ProyectoVidaUnidad1CierrePage;
