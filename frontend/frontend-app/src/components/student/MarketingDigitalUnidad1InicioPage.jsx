...
const MarketingDigitalUnidad1InicioPage = () => {
...
// Verificar si el video ya fue visto en está sesión
    ...
    const videoVisto = sessionStorage.getItem('md_unidad1_video_visto');
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/marketing-digital/unidad1/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Diagnóstico de Presencia Digital</span>
                  ...
                  if (videoRef.current) {
                    ...
                    if (progress >= 99.5 || video.currentTime >= video.duration - 0.5) {
                      ...
                      if (!videoMarkedAsSeen) {
                        ...
                        sessionStorage.setItem('md_unidad1_video_visto', 'true');
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En la primera unidad vamos a elaborar un diagnóstico, mediante una metodología de 5 pasos que nos facilite la comprensión del estado actual de la presencia digital de nuestro emprendimiento.
...
export default MarketingDigitalUnidad1InicioPage;
