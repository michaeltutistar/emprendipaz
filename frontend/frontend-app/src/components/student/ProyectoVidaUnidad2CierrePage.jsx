...
const preguntas = [

  {
    ...
    pregunta: '¿Por qué es importante reconocer las capacidades personales?',

    opciones: [

      { id: 'A', texto: 'Porque garantizan ingresos inmediatos.' },

      { id: 'B', texto: 'Porque permiten orientar el proyecto hacia escenarios de éxito.' },

      { id: 'C', texto: 'Porque evitan la necesidad de planificar.' }
...

  {
    ...
    pregunta: '¿Qué capacidad se relaciona directamente con ventas y marketing?',

    opciones: [

      { id: 'A', texto: 'Organización' },

      { id: 'B', texto: 'Resiliencia' },

      { id: 'C', texto: 'Comunicación' }
...

  {
    ...
    pregunta: '¿Qué fortaleza ayuda a sostener un negocio frente a épocas de crisis?',

    opciones: [

      { id: 'A', texto: 'Resiliencia' },

      { id: 'B', texto: 'Creatividad' },
...

  {
    ...
    pregunta: '¿Qué estrategia puede aplicarse para superar áreas de mejora?',

    opciones: [

      { id: 'A', texto: 'Evitar emprender.' },

      { id: 'B', texto: 'Comunicación.' },

      { id: 'C', texto: 'Capacitación, colaboración y delegación.' }
...

  {
    ...
    pregunta: '¿Qué capacidad facilita el ajuste a cambios en el mercado?',

    opciones: [

      { id: 'A', texto: 'Adaptabilidad' },

      { id: 'B', texto: 'Honestidad' },

      { id: 'C', texto: 'Perseverancia' }
        ...
        <div className="p-8 space-y-4">
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Felicitaciones! Has completado correctamente el cuestionario de cierre de la Unidad 2.
...
const ProyectoVidaUnidad2CierrePage = () => {
  ...
  const { pasoCompletado } = useProgressTracking('Proyecto de vida', 'Unidad 2: Evaluación');
...
const handleFinalizarUnidad = async () => {
    ...
    try {
      ...
      localStorage.setItem('pv_unidad2_cierre_completado', 'true');
      localStorage.setItem('pv_unidad2_completada', 'true');
      window.dispatchEvent(new Event('progreso-actualizado'));
...
export default ProyectoVidaUnidad2CierrePage;
