...
import { ArrowLeft, ChevronRight, Home, ExternalLink, Play, ChevronDown, LogOut } from 'lucide-react';
...
const Unidad2InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Marketing y Comercialización', 'Unidad 2: Inicio');
...
// Si el progreso ya existe en backend, habilitar el botón sin volver a ver el video
...
const handleCompleteStep = async () => {
    ...
    navigate('/student/unidad2/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Bases del direccionamiento estratégico</span>
            ...
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden shadow-xl">
              ...
              <video
                ...
                onEnded={() => {
                  ...
                  // Guardar progreso por usuario (backend)
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              inspira y motiva, marcando el destino deseado.

            </p>

            <p className="text-gray-700 leading-relaxed">

              Las estrategias son los puentes que conectan ambos puntos. Para ampliar los fundamentos sobre el

              direccionamiento estratégico, puedes revisar los recursos recomendados.
...
export default Unidad2InicioPage;
