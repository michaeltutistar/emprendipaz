...
import GlosarioTrabajoEquipoModal from './GlosarioTrabajoEquipoModal';

import BibliografiaTrabajoEquipoModal from './BibliografiaTrabajoEquipoModal';
...
const PresentaciónTrabajoEquipoPage = () => {
...
// Usar hook personalizado para cargar progreso desde backend
  ...
  } = useModuleProgress('Trabajo en Equipo');
...
const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Trabajo en Equipo');
...
// Cargar progreso desde backend y unidades disponibles

    const cargarDatos = async () => {

      await cargarProgresoDesdeBackend();

      // Cargar unidades disponibles de forma silenciosa (no bloquear si falla)

      cargarUnidadesDisponibles().catch(() => {

        // Si falla, las unidades ya están disponibles por defecto
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Trabajo en Equipo</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo7/M7INTRO.mp4"

                    poster="/Modulo7/screeninicio.jpg"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  descripcion="Aprende a identificar las funciones clave de tu equipo y a visualizar su estructura mediante organigramás circulares."
                  ...
                  ruta="/student/trabajo-equipo/unidad1"

                  delay={0.1}

                  textoBotonCompletada="Revisar Unidad"

                  textoBotonActiva="Comenzar Unidad"
...
{/* Unidad 2 */}
                ...
                <UnidadCard
                  ...
                  descripcion="Domina la metodología 5W2H para planificar actividades de manera efectiva y colaborativa."
                  ...
                  ruta="/student/trabajo-equipo/unidad2"
...
{/* Unidad 3 */}
                ...
                <UnidadCard
                  ...
                  titulo="Dificultades en el Equipo de Trabajo"

                  descripcion="Identifica dificultades comunes y aprende estrategias prácticas para resolverlas."
                  ...
                  ruta="/student/trabajo-equipo/unidad3"
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/trabajo-equipo/plan-negocio')}
...
{/* Modals */}
      ...
      {showBibliografia && <BibliografiaTrabajoEquipoModal onClose={() => setShowBibliografia(false)} />}

      {showGlosario && <GlosarioTrabajoEquipoModal onClose={() => setShowGlosario(false)} />}
...
export default PresentaciónTrabajoEquipoPage;
