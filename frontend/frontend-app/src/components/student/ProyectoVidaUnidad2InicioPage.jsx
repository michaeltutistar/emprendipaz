...
const ProyectoVidaUnidad2InicioPage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Proyecto de vida', 'Unidad 2: Presentación');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Fortalezas propias</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Esta unidad presenta los fundamentos sobre fortalezas propias. Reconoce tus capacidades y fortalezas

              personales para orientar tu emprendimiento hacia escenarios de éxito.

            </p>

            <p className="text-gray-700 leading-relaxed">

              A través de este recorrido, aprenderás a identificar tus fortalezas, reconocer cómo estas se relacionan

              con tu emprendimiento y cómo aprovecharlas para alcanzar tus objetivos.
...
export default ProyectoVidaUnidad2InicioPage;
