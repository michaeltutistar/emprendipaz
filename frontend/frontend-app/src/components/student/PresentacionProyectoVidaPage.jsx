...
import { ChevronRight, Home, ArrowLeft, Play, BookMarked, BookOpen, ArrowDown, ChevronDown, LogOut } from 'lucide-react';
...
import BibliografiaModal from './BibliografiaModal';
...
const PresentaciónProyectoVidaPage = () => {
  ...
  const [unidadesDisponibles, setUnidadesDisponibles] = useState({ 1: true, 2: false, 3: false });
...
// Usar hook personalizado para cargar progreso desde backend
  ...
  } = useModuleProgress('Proyecto de Vida');
  ...
  useEffect(() => {
    setModuloDisponible(true);
    setUnidadesDisponibles((prev) => ({
      1: true,
      2: prev[2] || unidad1Completada,
      3: prev[3] || unidad2Completada
    }));
  }, [unidad1Completada, unidad2Completada]);
  ...
  const cargarUnidadesDisponibles = async () => {
    try {
      ...
      const apiUrl = import.meta.env.MODE === 'production'
        ? `${API_BASE_URL}/student/modulos-disponibles`
        : `${API_BASE_URL}/student/modulos-disponibles`;
      ...
      if (response.ok) {
        ...
        if (data.success && data.modulos && data.modulos['Proyecto de vida']) {
          const moduloInfo = data.modulos['Proyecto de vida'];
          const disponible = moduloInfo.disponible === true;
          setModuloDisponible(disponible);

          // Convertir claves de string a número si vienen del backend como strings
          const unidades = moduloInfo.unidades || {};
...
// Solo usar el backend como fuente de verdad.
...
{/* CAPA FONDO 2: Patrón de hojas verdes con blending mode Overlay */}
...
{/* CAPA FRONTAL: Contenido estático y UI nítido */}
          ...
          <div className="max-w-7xl mx-auto relative z-20">
            ...
            {/* Fila superior: Logo izquierda, Título centro (condicional), Menú derecha */}

            <div className="flex items-center justify-between">

              {/* Logo EmprendePaz - Izquierda */}
...
{/* Título del Modulo - Centro (solo visible cuando showModuleTitle es true) */}
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Proyecto de vida</span>
...
{/* Botón Comenzar - Debajo del título */}
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo1/M1INTRO.mp4"

                    poster="/Modulo1/screeninicio.jpg"
...
{/* Instrucciones divididas en dos columnas */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-5xl mx-auto mb-8">
                ...
                <div className="bg-gradient-to-r from-[#59D22E]/10 to-[#A5E811]/10 border-l-4 border-[#59D22E] rounded-2xl p-6">
                  ...
                  <p className="text-gray-700 text-left" style={{ fontFamily: 'sans-serif' }}>
...
{/* Columna 2: Recursos */}
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-left mb-4" style={{ fontFamily: 'sans-serif' }}>
...
<p className="text-gray-600 text-lg max-w-3xl mx-auto" style={{ fontFamily: 'sans-serif' }}>
...
{/* Unidades - Grid */}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  unidadNumero={1}
                  titulo="Valores e intereses personales"
                  descripcion="Identifica tus valores esenciales y los intereses que guían tu emprendimiento para trabajar con pasión y propósito."
                  ...
                  ruta="/student/proyecto-vida/unidad1/inicio"
                  delay={0.1}
                ...
                <UnidadCard
                  unidadNumero={2}
                  titulo="Fortalezas propias"
                  descripcion="Reconoce tus capacidades y fortalezas personales para orientar tu emprendimiento hacia el éxito."
                  ...
                  ruta="/student/proyecto-vida/unidad2"
                  delay={0.2}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
                ...
                <UnidadCard
                  unidadNumero={3}
                  titulo="Plan de acción del proyecto de vida"
                  descripcion="Organiza metas y acciones de manera coherente, asignando recursos y tiempos específicos para tu proyecto."
                  ...
                  ruta="/student/proyecto-vida/unidad3"
                  delay={0.3}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/proyecto-vida/plan-negocio')}
...
{/* Modals */}
      ...
      {showBibliografia && <BibliografiaModal onClose={() => setShowBibliografia(false)} />}

      {showGlosario && <GlosarioModal onClose={() => setShowGlosario(false)} />}
...
export default PresentaciónProyectoVidaPage;
