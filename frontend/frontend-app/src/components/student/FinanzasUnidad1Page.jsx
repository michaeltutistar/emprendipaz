...
const FinanzasUnidad1Page = () => {
  ...
  const steps = [

    {
      ...
      ruta: '/student/finanzas/unidad1/inicio',

      descripcion: 'Video y contexto de la unidad sobre estudio de la ecuación patrimonial'
...

    {
      ...
      ruta: '/student/finanzas/unidad1/desarrollo',

      descripcion: 'Definición y componentes de la ecuación patrimonial, casos prácticos y lectura corta'
...

    {
      ...
      ruta: '/student/finanzas/unidad1/taller',

      descripcion: 'Identifica elementos contables y aplica la ecuación patrimonial'
...

    {
      ...
      ruta: '/student/finanzas/unidad1/cierre',

      descripcion: 'Cuestionario de 5 preguntas sobre la ecuación patrimonial'
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <p className="text-xs tracking-wide mb-1 opacity-80">MÓDULO: Finanzas y Gestión Empresarial</p>

          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Unidad 1: Estudio de la ecuación patrimonial</h1>
      ...
      <div className="bg-neutral-200 py-3 px-4 sm:px-8 border-b border-neutral-300 sticky top-[152px] z-40">
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-neutral-600">
          ...
          <button onClick={() => navigate('/student/finanzas')} className="hover:text-neutral-900 transition-colors">
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta unidad aprenderás sobre la contabilidad básica y la ecuación patrimonial, que te permitirá registrar y 

                comprender las operaciones económicas de tu empresa.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                La contabilidad es fundamental porque permite evaluar los recursos, costos, obligaciones y resultados de tu emprendimiento.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/finanzas/unidad1/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás la definición y componentes de la ecuación patrimonial, casos prácticos y una lectura corta 
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad1/desarrollo')}
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Aplica tus conocimientos identificando elementos contables y aplicando la ecuación patrimonial en ejercicios prácticos.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad1/taller')}
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre la ecuación patrimonial antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/finanzas/unidad1/cierre')}
...
export default FinanzasUnidad1Page;
