...
const preguntas = [

  {
    ...
    pregunta: '¿Cuál es la diferencia entre análisis financiero y plan de inversión documento?',

    opciones: [

      { id: 'a', texto: 'Son lo mismo' },

      { id: 'b', texto: 'El análisis financiero calcula indicadores; el plan documento integra indicadores + cronograma + riesgos + seguimiento' },

      { id: 'c', texto: 'El plan documento es solo para bancos' }
...

  {
    ...
    pregunta: '¿Qué elemento asegura que las tareas se cumplan en tiempos definidos?',

    opciones: [

      { id: 'a', texto: 'Presupuesto' },

      { id: 'b', texto: 'Cronograma' },
...

  {
    ...
    pregunta: '¿Qué indicador de seguimiento permite detectar problemas de ventas a tiempo?',

    opciones: [

      { id: 'a', texto: 'Flujo de caja' },

      { id: 'b', texto: 'Punto de equilibrio' },

      { id: 'c', texto: 'Ventas reales vs proyectadas' }
...

  {
    ...
    pregunta: '¿Qué acción corresponde a una desviación mayor en la ejecución?',

    opciones: [

      { id: 'a', texto: 'Ajustes operativos menores' },

      { id: 'b', texto: 'Replanificación formal' },

      { id: 'c', texto: 'Continuar sin cambios' }
...

  {
    ...
    pregunta: '¿Por qué es importante definir responsables con nombre propio en el cronograma?',

    opciones: [

      { id: 'a', texto: 'Para asegurar claridad y responsabilidad en la ejecución' },

      { id: 'b', texto: 'Para medir cambios en el mercado' },

      { id: 'c', texto: 'Para reducir costos' }
        ...
        <div className="p-8 space-y-4">
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Felicitaciones! Has completado la Unidad 3 de Plan de Inversión.
...
const PlanInversionUnidad3CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Plan de Inversión', 'Unidad 3: Evaluación');
...
useEffect(() => {
    ...
    const savedRespuestas = localStorage.getItem('plan_inversion_unidad3_evaluación_respuestas');
...
const handleRespuesta = (preguntaId, opcionId) => {
    ...
    setRespuestas(prev => {
      ...
      localStorage.setItem('plan_inversion_unidad3_evaluación_respuestas', JSON.stringify(nuevasRespuestas));
        ...
        <div className="max-w-7xl mx-auto px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">
              ...
              Formulación, Implementación y Seguimiento del Plan de Inversión
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Para cerrar la Unidad 3: "Formulación, Implementación y Seguimiento del Plan de Inversión", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default PlanInversionUnidad3CierrePage;
