...
const TrabajoEquipoUnidad3InicioPage = () => {
...
const handleCompleteStep = async () => {
    ...
    try {
      ...
      navigate('/student/trabajo-equipo/unidad3/desarrollo');
...
<div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Dificultades en el Equipo</span>
...
{/* Texto - Columna derecha (30%) */}
          ...
          <div className="lg:col-span-3 flex flex-col justify-center gap-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              En esta unidad aprenderás a identificar y resolver las dificultades comunes en los equipos de trabajo, aplicando estrategias prácticas para fomentar la confianza, el compromiso y la colaboración.

            </p>

            <p className="text-gray-700 leading-relaxed">

              El trabajo en equipo implica coordinar personas con distintas formas de pensamiento, comunicación y acción. Esta diversidad puede generar dificultades si no se gestiona adecuadamente.
...
export default TrabajoEquipoUnidad3InicioPage;
