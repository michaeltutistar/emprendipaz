...
const preguntas = [

  {
    ...
    pregunta: '¿Cuál de las siguientes afirmaciones describe mejor la relación entre el Ciclo de Vida del Producto y el Diagnóstico Estratégico?',

    opciones: [

      { id: 'a', texto: 'El Ciclo de Vida del Producto determina automáticamente la estrategia de la empresa sin necesidad de análisis adicional.' },

      { id: 'b', texto: 'El Diagnóstico Estratégico identifica la etapa del Ciclo de Vida del Producto y ayuda a definir acciones adecuadas para cada fase.' },

      { id: 'c', texto: 'El Diagnóstico Estratégico solo se aplica a productos en declive.' },

      { id: 'd', texto: 'El Ciclo de Vida del Producto y el Diagnóstico Estratégico no tienen ninguna conexión entre sí.' }
...

  {
    ...
    pregunta: '¿En cuál de los siguientes casos el Diamante de Porter ayuda a comprender mejor la situación de un producto en su etapa de crecimiento dentro del Ciclo de Vida?',

    opciones: [

      { id: 'a', texto: 'Cuando se necesita evaluar si las condiciones de demanda y la competencia favorecen la expansión del producto.' },

      { id: 'b', texto: 'Cuando el producto se encuentra en declive y la empresa quiere retirarlo del mercado.' },

      { id: 'c', texto: 'Solo cuando la empresa estudia costos de producción internos.' },

      { id: 'd', texto: 'Únicamente para comparar ventas históricas del producto.' }
...

  {
    ...
    pregunta: '¿Qué combinación describe correctamente cómo interactúan el Diagnóstico Estratégico, el Diamante de Porter y el Ciclo de Vida del Producto?',

    opciones: [

      { id: 'a', texto: 'El Diagnóstico Estratégico se enfoca solo en factores internos, el Diamante de Porter solo en finanzas y el CVP solo en publicidad.' },

      { id: 'b', texto: 'El Diagnóstico Estratégico integra información del Diamante de Porter para analizar el entorno y del CVP para entender la evolución del producto.' },

      { id: 'c', texto: 'El Diamante de Porter reemplaza al Diagnóstico Estratégico cuando el producto está en introducción.' },

      { id: 'd', texto: 'El Ciclo de Vida del Producto determina la competitividad nacional analizada por Porter.' }
...

  {
    ...
    pregunta: '¿Qué estrategia es clave en la madurez?',

    opciones: [

      { id: 'a', texto: 'Diferenciación e innovación' },

      { id: 'b', texto: 'Degustaciones gratuitas' },

      { id: 'c', texto: 'Retiro de productos' }
...

  {
    ...
    pregunta: '¿Qué caracteriza la etapa de introducción?',

    opciones: [

      { id: 'a', texto: 'Alta inversión en promoción y posicionamiento' },

      { id: 'b', texto: 'Ventas estables y competencia fuerte' },
...
const DescubrimientoUnidad3CierrePage = () => {

  const navigate = useNavigate();

  const { pasoCompletado, registrarProgreso } = useProgressTracking('Descubrimiento de Oportunidades', 'Unidad 3: Evaluación');
...
const todasCorrectas = preguntasIncorrectas.length === 0;
...
const handleFinalizar = async () => {
    ...
    try {
      ...
      localStorage.setItem('descubrimiento_unidad3_completada', 'true');
        ...
        <div className="max-w-7xl mx-auto px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">
              ...
              Ciclo de Vida del Producto · Evaluación
          ...
          <div className="mb-6">
            ...
            <div className="bg-purple-50 border-l-4 border-[#AA27B9] p-4 rounded">
              ...
              <p className="text-gray-700 text-sm md:text-base">
                ...
                <strong>📌 Instrucciones:</strong> Para cerrar la unidad 3 realiza el siguiente cuestionario y pon a prueba tus conocimientos

                en función al modulo completo "DESCUBRIMIENTO DE OPORTUNIDADES".
...
export default DescubrimientoUnidad3CierrePage;
