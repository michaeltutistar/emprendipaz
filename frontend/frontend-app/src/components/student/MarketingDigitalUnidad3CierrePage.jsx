...
const preguntas = [

  {
    ...
    pregunta: '¿Qué es una estrategia de marketing digital?',

    opciones: [

      { id: 'A', texto: 'Un plan de acción diseñado para alcanzar un objetivo a corto o a largo plazo' },

      { id: 'B', texto: 'Los valores de la empresa' },

      { id: 'C', texto: 'Un diagnóstico empresarial' }
...

  {
    ...
    pregunta: '¿Cuál de las siguientes es una ventaja de una estrategia de marketing digital?',

    opciones: [

      { id: 'A', texto: 'Mejora el diseño del logo de mi empresa' },

      { id: 'B', texto: 'Mejora la visibilidad de la marca a través de los canales digitales' },

      { id: 'C', texto: 'Mejora mi relación con la competencia' }
...

  {
    ...
    pregunta: '¿Cómo se llama la estrategia de marketing digital en la cual la empresa colabora con un personaje reconocido para promocionar su producto?',

    opciones: [

      { id: 'A', texto: 'SEO' },

      { id: 'B', texto: 'Análisis del entorno' },

      { id: 'C', texto: 'Marketing de influencers' }
...

  {
    ...
    pregunta: '¿Cuál se llama la estrategia para promocionar contenido de la empresa mediante pago de publicidad digital?',

    opciones: [

      { id: 'A', texto: 'Marketing de contenidos' },

      { id: 'B', texto: 'Publicidad pago' },

      { id: 'C', texto: 'Innovación de procesos' }
...

  {
    ...
    pregunta: 'Una empresa de helados artesanales ha invitado a que sus clientes compartan en sus redes sociales personales una foto probando alguno de sus productos, etiquetando a la empresa, la publicación con mayor cantidad de interacciones ganará una semana de helados gratis. ¿Cómo se llamaría esta estrategia?',

    opciones: [

      { id: 'A', texto: 'Contenido generado por el cliente' },

      { id: 'B', texto: 'SEM' },

      { id: 'C', texto: 'Publicidad pago' }
        ...
        <div className="p-8 space-y-4">
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Felicitaciones! Puedes finalizar la Unidad 3.
          ...
          <Button
            ...
            className="w-full bg-[#AA27B9] hover:bg-[#9d24ab] text-white py-3"
...
const MarketingDigitalUnidad3CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Marketing Digital', 'Unidad 3: Cierre');
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem('marketingDigitalUnidad3Cierre');
  ...
  const handleRespuesta = (preguntaId, opcionId) => {
    ...
    localStorage.setItem('marketingDigitalUnidad3Cierre', JSON.stringify(nuevasRespuestas));
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              Estrategias de Marketing Digital · Evaluación

            </h1>

            <p className="text-white/80 max-w-2xl text-sm md:text-base mb-8">

              Evalúa tus conocimientos sobre estrategias de marketing digital.
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
          ...
          <div className="mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-neutral-900 mb-2">Evaluación: Estrategias de Marketing Digital</h2>
            ...
            {evaluaciónBloqueada ? (
              ...
              <div className="bg-neutral-100 border-l-4 border-neutral-900 p-4 rounded">
                ...
                <p className="text-neutral-700 text-sm md:text-base">
                  ...
                  <strong>📌 Instrucciones:</strong> Responde las siguientes 5 preguntas de selección múltiple.

                  Debes responder todas correctamente para finalizar la unidad.
          ...
          <div className="space-y-8 mb-8">
            ...
            {preguntas.map((pregunta) => (
              ...
              <div key={pregunta.id} className="bg-white border-2 border-neutral-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  {pregunta.opciones.map((opcion) => {
                    ...
                    const showFeedback = mostrarResultado && isSelected;
          ...
          <div className="flex justify-end gap-4">
            ...
            {!mostrarResultado && !evaluaciónBloqueada ? (
              ...
              <Button
                ...
                className={`px-8 py-4 flex items-center gap-2 ${todasRespondidas && !cargandoEstado
...
export default MarketingDigitalUnidad3CierrePage;
