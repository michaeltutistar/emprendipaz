...
const preguntas = [

  {
    ...
    pregunta: 'El direccionamiento estratégico permite a una organización:',

    opciones: [

      { id: 'A', texto: 'Definir acciones para el corto plazo únicamente.' },

      { id: 'B', texto: 'Establecer la ruta y objetivos de mediano y largo plazo.' },

      { id: 'C', texto: 'Evitar la toma de decisiones complejas.' }
...

  {
    ...
    pregunta: 'La misión describe:',

    opciones: [

      { id: 'A', texto: 'Lo que la organización quiere ser en el futuro.' },

      { id: 'B', texto: 'Los valores éticos del equipo.' },

      { id: 'C', texto: 'Las actividades presentes y su razón de ser.' }
...

  {
    ...
    pregunta: 'La visión de una empresa se refiere a:',

    opciones: [

      { id: 'A', texto: 'El objetivo financiero del año.' },

      { id: 'B', texto: 'La proyección futura deseada de la organización.' },

      { id: 'C', texto: 'Las tareas operativas diarias.' }
...

  {
    ...
    pregunta: 'Un objetivo estratégico se caracteriza por ser:',

    opciones: [

      { id: 'A', texto: 'Exclusivo del área de marketing.' },

      { id: 'B', texto: 'General, sin indicadores.' },

      { id: 'C', texto: 'Claro, medible y orientado al largo plazo.' }
...

  {
    ...
    pregunta: 'Una buena visión organizacional debe ser:',

    opciones: [

      { id: 'A', texto: 'Inspiradora y orientar el futuro deseado.' },

      { id: 'B', texto: 'Una lista detallada de procesos internos.' },

      { id: 'C', texto: 'Únicamente una meta financiera de corto plazo.' }
        ...
        <div className={`py-6 px-8 rounded-t-2xl ${todoCorrecto ? 'bg-gradient-to-r from-green-600 to-green-500' : 'bg-gradient-to-r from-red-600 to-red-500'}`}>
          ...
          <div className="flex items-center justify-center gap-3 text-white">
            ...
            <div>
              ...
              <h2 className="text-[24px] font-bold">{todoCorrecto ? '¡Excelente!' : 'Revisa tus respuestas'}</h2>

              <p className="text-sm">

                {todoCorrecto ? 'Has completado la evaluación correctamente.' : 'Algunas respuestas necesitan ajuste.'}
        ...
        <div className="p-8 space-y-4">
          ...
          {!todoCorrecto && (
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <p className="font-bold text-red-900 mb-2">Preguntas por revisar:</p>

              <ul className="space-y-2 text-sm text-red-700">

                {resultado.incorrectas.map((error) => (

                  <li key={error.pregunta}>• Pregunta {error.pregunta}: seleccionaste {error.respuesta || 'Sin respuesta'}</li>
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Listo! Puedes continuar con la siguiente unidad.
...
const Unidad2CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Marketing y Comercialización', 'Unidad 2: Evaluación');
  ...
  // Sincronizar con progreso guardado en backend
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              Bases del direccionamiento estratégico · Evaluación

            </h1>

            <p className="text-white/80 max-w-2xl text-sm md:text-base mb-8">

              Evalúa tus conocimientos sobre misión, visión y estrategias organizacionales.
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-2xl md:text-[32px] font-bold text-neutral-900 mb-4">1.3 Cierre</h2>

            <h3 className="text-xl md:text-2xl font-bold text-neutral-800 mb-2">EVALUACIÓN UNIDAD DOS</h3>

            <p className="text-neutral-700 font-semibold mb-4">Bases del direccionamiento estratégico</p>

            <p className="text-neutral-600 text-sm md:text-base">

              Responde las cinco preguntas para confirmar que dominas los conceptos clave del direccionamiento estratégico.
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-between">
            ...
            <Button
              ...
              onClick={() => navigate('/student/unidad2/taller')}
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              ...
              <Button
                ...
                className={`bg-neutral-900 hover:bg-neutral-800 text-white px-8 py-4 ${!todasRespondidas ? 'opacity-40 cursor-not-allowed' : ''
      ...
      {resultado && <ResultadoModal resultado={resultado} onClose={() => setResultado(null)} />}
...
export default Unidad2CierrePage;
