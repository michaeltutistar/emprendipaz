...
const preguntas = [

  {
    ...
    pregunta: '¿Qué puedo realizar si conozco la estructura de mi equipo de trabajo?',

    opciones: [

      { id: 'A', texto: 'Controlar cada tarea personalmente.' },

      { id: 'B', texto: 'Delegar sin supervisión.' },

      { id: 'C', texto: 'Distribuir funciones y mejorar los resultados.' }
...

  {
    ...
    pregunta: '¿Qué tipo de función cumple quien atiende clientes?',

    opciones: [

      { id: 'A', texto: 'Administrativa' },

      { id: 'B', texto: 'Comercial' },
...

  {
    ...
    pregunta: '¿Qué puede ocurrir si NO se definen bien las funciones de los colaboradores?',

    opciones: [

      { id: 'A', texto: 'Se mejora la autonomía.' },

      { id: 'B', texto: 'Se duplican tareas y se pierde eficiencia.' },

      { id: 'C', texto: 'Se fortalece el trabajo en equipo.' }
...

  {
    ...
    pregunta: 'El organigrama circular representa el trabajo colaborativo entre las diferentes áreas.',
...

  {
    ...
    pregunta: 'La persona que maneja las redes sociales de un emprendimiento tiene una función operativa.',
        ...
        <div className="p-8 space-y-4">
          ...
          {todoCorrecto && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center text-green-800">
              ...
              ¡Felicitaciones! Has completado la Unidad 1 de Trabajo en Equipo.
...
const TrabajoEquipoUnidad1CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Trabajo en Equipo', 'Unidad 1: Evaluación');
        ...
        <div className="max-w-7xl mx-auto px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">
              ...
              Conformación del Equipo · Evaluación
...
<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col lg:flex-row lg:items-start gap-4 lg:gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/80 max-w-2xl text-sm md:text-base mb-8">
                ...
                Para cerrar la unidad 1, realiza el siguiente cuestionario y pon a prueba tus conocimientos sobre conformación del equipo de trabajo.
          ...
          <div className="mb-6">
            ...
            <div className="bg-neutral-100 border-l-4 border-green-400/80 p-4 rounded">
              ...
              <p className="text-neutral-700 text-sm md:text-base">
                ...
                Para cerrar la unidad 1 "Conformación del equipo de trabajo", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default TrabajoEquipoUnidad1CierrePage;
