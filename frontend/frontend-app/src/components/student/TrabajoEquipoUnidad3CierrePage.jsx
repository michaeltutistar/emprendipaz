...
const preguntas = [

  {
    ...
    pregunta: '¿Cuál es un beneficio de identificar las dificultades del equipo de trabajo?',

    opciones: [

      { id: 'A', texto: 'Castigar a los responsables.' },

      { id: 'B', texto: 'Mejorar el ambiente laboral y buscar soluciones.' },

      { id: 'C', texto: 'Evitar reuniones con la gerencia.' }
...

  {
    ...
    pregunta: '¿Cuál puede ser la causa de una falta de compromiso de los colaboradores?',

    opciones: [

      { id: 'A', texto: 'Disminución de los recursos económicos.' },

      { id: 'B', texto: 'Objetivos poco claros o decisiones impuestas.' },

      { id: 'C', texto: 'Miedo a la crítica.' }
...

  {
    ...
    pregunta: '¿Qué solución es la adecuada ante la falta de confianza de los colaboradores?',

    opciones: [

      { id: 'A', texto: 'Asignar actividades sin preguntar.' },

      { id: 'B', texto: 'Hacer reuniones más largas.' },

      { id: 'C', texto: 'Generar espacios seguros para compartir errores.' }
...

  {
    ...
    pregunta: '¿Qué hacer si el equipo de trabajo evita los conflictos y no los enfrenta?',

    opciones: [

      { id: 'A', texto: 'Promover el debate respetuoso.' },

      { id: 'B', texto: 'Reasignar las funciones del equipo.' },

      { id: 'C', texto: 'Cambiar el líder.' }
...

  {
    ...
    pregunta: '¿Imponer órdenes de forma autoritaria favorece la resolución de conflictos?',
...
const TrabajoEquipoUnidad3CierrePage = () => {
  ...
  const { pasoCompletado, registrarProgreso } = useProgressTracking('Trabajo en Equipo', 'Unidad 3: Evaluación');
        ...
        <div className="max-w-7xl mx-auto px-8 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#AA27B9] font-bold text-base">
              ...
              Dificultades en el Equipo · Evaluación
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col lg:flex-row lg:items-start gap-4 lg:gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/80 max-w-2xl text-sm md:text-base mb-8">
                ...
                Para cerrar la unidad 3, realiza el siguiente cuestionario y pon a prueba tus conocimientos sobre dificultades en el equipo de trabajo.
          ...
          <div className="mb-6">
            ...
            <div className="bg-neutral-100 border-l-4 border-green-400/80 p-4 rounded">
              ...
              <p className="text-neutral-700 text-sm md:text-base">
                ...
                Para cerrar la unidad 3 "Dificultades en el equipo de trabajo", realiza el siguiente cuestionario y pon a prueba tus conocimientos.
...
export default TrabajoEquipoUnidad3CierrePage;
