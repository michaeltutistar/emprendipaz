...
const Unidad1Page = () => {
  ...
  const [activeStep, setActiveStep] = useState(1); // 1: Presentación, 2: Fundamentación, 3: Taller, 4: Evaluación

  const [completedSteps, setCompletedSteps] = useState(new Set([1])); // Paso 1 completado por defecto



  // Determinar paso activo basado en la ruta
  ...
  const steps = [

    {
      ...
      ruta: '/student/unidad1/inicio',

      descripcion: 'Video y contexto de la unidad sobre caracterización DOFA'
...

    {
      ...
      ruta: '/student/unidad1/desarrollo',

      descripcion: 'Lectura guiada, tabla DOFA y caso práctico de cafetería'
...

    {
      ...
      ruta: '/student/unidad1/taller',

      descripcion: 'Construye tu propia matriz DOFA aplicada al emprendimiento'
...

    {
      ...
      ruta: '/student/unidad1/evaluacion',
    ...
    <div className="min-h-screen bg-neutral-50 overflow-x-hidden">
      ...
      <div className="bg-neutral-900 text-white py-6 px-4 sm:px-8 sticky top-[76px] z-40 shadow-md">
        ...
        <div className="max-w-5xl mx-auto text-center min-h-[80px] flex flex-col justify-center">
          ...
          <h1 className="text-2xl sm:text-[32px] md:text-[36px] font-bold italic">Fundamentos del Marketing</h1>
      ...
      {/* Content Area - Renderizar contenido según el paso activo */}
          ...
          {activeStep === 1 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Empezaremás reconociendo la situación interna y externa del negocio usando la matriz DOFA. Este paso permite tomar decisiones con información real sobre fortalezas, debilidades, oportunidades y amenazas.

              </p>

              <p className="text-neutral-600 mb-8 text-sm md:text-base">

                Verás el video introductorio, revisarás los componentes de la matriz y conocerás cómo aplicarla a tu emprendimiento antes de continuar con el taller.
                ...
                <div className="bg-neutral-200 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <button
                      ...
                      onClick={() => navigate('/student/unidad1/inicio')}
          ...
          {activeStep === 2 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                En esta sección revisarás el video “¿Cómo hacer el análisis o matriz DOFA empresarial?”, la descripción de cada componente y el caso práctico de una cafetería local.
          ...
          {activeStep === 3 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Llevarás la teoría a tu emprendimiento elaborando una matriz DOFA completa. Debes describir mínimo dos elementos por cuadrante y justificar tus decisiones.
          ...
          {activeStep === 4 && (
            ...
            <div>
              ...
              <p className="text-neutral-600 mb-4 text-sm md:text-base">
                ...
                Responde las cinco preguntas de selección múltiple sobre el diagnóstico interno y externo antes de finalizar la unidad.
              ...
              <div className="flex justify-center my-8">
                ...
                <Button
                  ...
                  onClick={() => navigate('/student/unidad1/evaluacion')}
