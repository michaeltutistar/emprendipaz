...
import BibliografiaModeloNegociosModal from './BibliografiaModeloNegociosModal';
...
const PresentaciónModeloNegociosPage = () => {
  ...
  } = useModuleProgress('Modelo de Negocios');
  ...
  const cargarUnidadesDisponibles = async () => {
    ...
    try {
      const availability = await fetchModuleAvailability('Modelo de Negocios');
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#006837] via-[#00844a] to-[#59D22E]">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {!isScrolled && (
            ...
            >
              ...
              <span className="text-white font-semibold">Modelo de Negocios</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-4 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl aspect-video relative overflow-hidden">
                  ...
                  <video
                    ...
                    src="/Modulo3/M3INTRO.mp4"

                    poster="/Modulo3/screeninicio.jpg"
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <UnidadCard
                  ...
                  unidadNumero={1}
                  titulo="Fundamentos del Modelo de Negocio"
                  descripcion="Aprende los conceptos fundamentales del modelo de negocio y el Business Model Canvas."
                  estaCompletada={unidad1Completada}
                  estaDisponible={unidadesDisponibles[1] ?? true}
                  unidadAnteriorCompletada={true}
                  ruta="/student/modelo-negocios/unidad1"
                  delay={0.1}
                ...
                <UnidadCard
                  ...
                  unidadNumero={2}
                  titulo="Análisis de Segmentos, Canales y Propuesta de Valor"
                  descripcion="Profundiza en la segmentación de clientes, gestión de canales y validación de la propuestá de valor."
                  estaCompletada={unidad2Completada}
                  estaDisponible={unidadesDisponibles[2] ?? false}
                  unidadAnteriorCompletada={unidad1Completada}
                  ruta="/student/modelo-negocios/unidad2"
                  delay={0.2}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
                ...
                <UnidadCard
                  ...
                  unidadNumero={3}
                  titulo="Recursos, Ingresos, Costos y Validación del Modelo"
                  descripcion="Aprende sobre recursos clave, análisis de costos, punto de equilibrio y validación del modelo mediante metodologías como Lean Startup."
                  estaCompletada={unidad3Completada}
                  estaDisponible={unidadesDisponibles[3] ?? false}
                  unidadAnteriorCompletada={unidad2Completada}
                  ruta="/student/modelo-negocios/unidad3"
                  delay={0.3}
                  textoBotonCompletada="Revisar Unidad"
                  textoBotonActiva="Empezar"
                />
              ...
              <div className="mt-10 text-center">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => navigate('/student/modelo-negocios/plan-negocio')}
      ...
      {showBibliografia && <BibliografiaModeloNegociosModal onClose={() => setShowBibliografia(false)} />}
...
export default PresentaciónModeloNegociosPage;
